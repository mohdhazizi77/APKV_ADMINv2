...
<table class="fbform">
    ...
    <tr>
        ...
        <td style="width: 2%">:</td>
        <td>
            <asp:DropDownList ID="ddlTahun" runat="server" AutoPostBack="True" Width="150px"></asp:DropDownList>
        </td>
    </tr>
    <tr>
        <td>Kod Pusat</td>
        <td>:</td>
        <td>
            <asp:DropDownList ID="ddlKodPusat" runat="server" AutoPostBack="True" Width="150px"></asp:DropDownList>
        </td>
    </tr>
    <tr>
        <td>Semester</td>
        <td>:</td>
        <td>
            <asp:DropDownList ID="ddlSemester" runat="server" AutoPostBack="True" Width="150px"></asp:DropDownList>
        </td>
    </tr>
    <tr>
        <td>Sesi</td>
