...
Public Class markah_vokasional_list
    ...
    Private Sub hiddencolumn()
        ...
        Select Case strRet
            Case "4"
                ...
                datRespondent.Columns.Item("10").Visible = False 'modul 1=5
    ...
    Private Function getSQL() As String
        ...
        tmpSQL += " kpmkv_pelajar_markah.GredV7, kpmkv_pelajar_markah.GredV8,kpmkv_pelajar_markah.SMP_Total,kpmkv_pelajar_markah.SMP_Grade FROM kpmkv_pelajar_markah LEFT OUTER JOIN  kpmkv_pelajar ON kpmkv_pelajar_markah.PelajarID = kpmkv_pelajar.PelajarID "
        ...
        End If
        '--jantina
        If Not ddlKelas.SelectedValue = "PILIH" Then
