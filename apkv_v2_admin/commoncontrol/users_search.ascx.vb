...
Public Class users_search
    ...
    Private Sub kpmkv_usertype_list()
        strSQL = "SELECT Usertype FROM kpmkv_usertype  ORDER BY Usertype"
        Dim strConn As String = ConfigurationManager.AppSettings("ConnectionString")
        Dim objConn As SqlConnection = New SqlConnection(strConn)
    ...
    '    strSQL = "SELECT MenuCode,MenuDesc FROM kpmkv_menu  WHERE MenuCat='USERS-LIST' ORDER BY SeqNo"
    '    Dim strConn As String = ConfigurationManager.AppSettings("ConnectionString")
    '    Dim objConn As SqlConnection = New SqlConnection(strConn)
    '    Dim sqlDA As New SqlDataAdapter(strSQL, objConn)
    ...
    Private Function getSQL() As String
        ...
        strWhere = "  WHERE UserType<>'SYSADMIN'"
