...
Public Class pentaksirbm_borang_markah_induk1
    ...
    Private Sub ddlJenisBorang_list()
        ...
        strSQL = "  SELECT DISTINCT MataPelajaran FROM kpmkv_pentaksir_bmsetara"
        ...
        Try
            ...
            ddlJenisBorang.DataTextField = "MataPelajaran"
            ddlJenisBorang.DataValueField = "MataPelajaran"
    ...
    Private Sub ddlPP_list()
        ...
        strSQL = "  SELECT kpmkv_kolej.Nama, kpmkv_kolej.Kod 
                    FROM kpmkv_kolej
                    LEFT JOIN kpmkv_users ON kpmkv_users.Negeri = kpmkv_kolej.Negeri
    ...
    Private Sub printBMI()
        ...
        Try
            ...
            cell = New PdfPCell()
            cetak = Environment.NewLine & "SIDANG"
            ...
            cell = New PdfPCell()
            cetak = Environment.NewLine & ddlSidang.SelectedValue
            cetak += Environment.NewLine & txtTarikh.Text & " / " & ddlMasa.SelectedValue
            cetak += Environment.NewLine
            cell.AddElement(New Paragraph(cetak, FontFactory.GetFont("Arial", 8)))
            cell.Border = 0
            table.AddCell(cell)
