<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="markah_ulang_SJSetara.ascx.vb" Inherits="apkv_v2_admin.markah_ulang_SJSetara1" %>

<table class="fbform">
    <tr class="fbform_header">
        <td colspan="2">Pendaftaran Calon Ulang >> SJ Setara</td>
    </tr>
</table>
        ...
        <td>
            <asp:GridView ID="datRespondent" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Markah SJ">
                        <ItemTemplate>
                            <asp:Label ID="MarkahBM" runat="server" Width="30px" Text='<%# Bind("Sejarah")%>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Gred SJ">
                        <ItemTemplate>
                            <asp:Label ID="GredBM" runat="server" Width="30px" Text='<%# Bind("GredSJ")%>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Markah SJ Ulang">
                        <ItemTemplate>
                            <asp:Label ID="MarkahBMUlang" runat="server" Width="30px"  Text='<%# Bind("SejarahUlang")%>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Gred SJ Ulang">
                        <ItemTemplate>
                            <asp:Label ID="GredBMUlang" runat="server" Width="30px" Text='<%# Bind("GredSJUlang")%>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="PointerSJSetara">
                        <ItemTemplate>
                            <asp:Label ID="PointerUlang" runat="server" Width="30px" Text='<%# Bind("PointerSJUlang")%>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="GredSJSetara">
                        <ItemTemplate>
                            <asp:Label ID="GredPointerUlang" runat="server" Width="30px" Text='<%# Bind("GredPointerSJUlang")%>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
...
<table class="fbform">
    ...
    <tr>
        <td colspan="2">
            ...
            <asp:Label ID="janagred" runat="server" Text="jana gred sj ulang"></asp:Label>
        </td>
    </tr>
    <tr>
        <td colspan="2">
    ...
    <tr>
        <td colspan="2">
            ...
            <asp:Label ID="Label1" runat="server" Text="kemaskini markah sj"></asp:Label>
        </td>
    </tr>
</table>
