<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="inden_matapelajaran_akademik.ascx.vb" Inherits="apkv_v2_admin.inden_matapelajaran_akademik" %>
<table class="fbform" style ="width :100%">
    <tr class="fbform_header">
        <td colspan="3">Analisa Matapelajaran Akademik Mengikut KV</td>
    </tr>
    <tr>
