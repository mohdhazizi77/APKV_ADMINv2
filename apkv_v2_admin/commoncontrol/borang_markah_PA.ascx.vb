...
Public Class borang_markah_PA
    ...
    Private Sub kpmkv_kodkursus_list()
        ...
        strSQL += " WHERE kpmkv_kelas.KolejRecordID='" & ddlKodPusat.SelectedValue & "' AND kpmkv_kursus.Tahun='" & ddlTahun.Text & "' AND kpmkv_kursus.Sesi='" & chkSesi.SelectedValue & "'  GROUP BY kpmkv_kursus.KodKursus, kpmkv_kursus.KursusID"
        Dim strConn As String = ConfigurationManager.AppSettings("ConnectionString")
        Dim objConn As SqlConnection = New SqlConnection(strConn)
        Dim sqlDA As New SqlDataAdapter(strSQL, objConn)
    ...
    Private Function getSQL() As String
        ...
        tmpSQL = "SELECT kpmkv_pelajar.PelajarID, kpmkv_pelajar.MYKAD, kpmkv_pelajar.AngkaGiliran,kpmkv_pelajar_markah.A_Teori1,kpmkv_pelajar_markah.CatatanPA"
        ...
        strWhere = " WHERE kpmkv_pelajar.IsDeleted='N' and kpmkv_pelajar.StatusID='2' AND kpmkv_pelajar.KolejRecordID='" & ddlKodPusat.SelectedValue & "'"
    ...
    Private Sub CreatePDF(ByVal tableColumns As DataColumnCollection, ByVal tableRows As DataRowCollection)
        ...
        Try
            ...
            msFileName = "BorangMarkahPA" & ddlKodKursus.Text & ".pdf"
            ...
            Dim strKodMatapelajaran As String = ""
            ...
            strSQL = "SELECT KodMPVOK FROM kpmkv_matapelajaran_v WHERE KursusID='" & ddlKodKursus.Text & "' AND Semester = '" & ddlSemester.Text & "'"
            strKodMatapelajaran = oCommon.getFieldValue(strSQL)
            ...
            Dim myPara05 As New Paragraph("PENTAKSIRAN PUSAT SEMESTER " & ddlSemester.Text & ", " & "SESI, " & chkSesi.Text & ", " & ddlTahun.Text, FontFactory.GetFont("Arial", 10, Font.BOLD))
            myPara05.Alignment = Element.ALIGN_CENTER
            myDocument.Add(myPara05)

            Dim myPara06 As New Paragraph("BORANG PENTAKSIRAN VOKASIONAL", FontFactory.GetFont("Arial", 10, Font.BOLD))
            ...
            Dim Cell3TTL As New PdfPCell(New Phrase("KOD MATAPELAJARAN", FontFactory.GetFont("Arial", 9, Font.NORMAL)))
            Cell3TTL.Border = Rectangle.NO_BORDER
            myTableTitle.AddCell(Cell3TTL)

            Dim Cell4TTL As New PdfPCell(New Phrase("" & strKodMatapelajaran, FontFactory.GetFont("Arial", 9, Font.NORMAL)))
