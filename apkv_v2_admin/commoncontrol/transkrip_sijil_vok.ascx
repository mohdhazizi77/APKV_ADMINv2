...
<table class="fbform">
    ...
    <tr>
        ...
        <td>
            ...
            <a href="~/prm.pengarahPeperiksaan.aspx" target="_blank" runat="server" style="color: green; font: 9px; vertical-align: middle">[+]Konfigurasi</a>
        </td>
    </tr>
</table>
<br />
...
<table class="fbform" style="width: 100%">
    ...
    <tr>
        <td colspan="2">
            ...
            <asp:Button ID="btnPrintSlipNegeri" runat="server" Width="200px" Text="Cetak Slip Keputusan Negeri" CssClass="fbbutton" />&nbsp;<asp:HyperLink ID="HyperLink1" runat="server" Target="_blank"
                Visible="false">Klik disini untuk muat turun.</asp:HyperLink>
        </td>
    </tr>
</table>
