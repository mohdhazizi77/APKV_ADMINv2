<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="permohonan.pindah.update.ascx.vb" Inherits="apkv_v2_admin.permohonan_pindah_update" %>
...
<table class="fbform">
    ...
    <tr>
        ...
        <asp:CheckBox ID="chkconfirm" runat="server" text=""/>
           <asp:Label ID="lblConfirm" runat="server" Text="Calon ini telah mendapat kelulusan berpindah daripada bahagian BPTV pada tarikh " Font-Bold="False" ForeColor="Red"></asp:Label>:<asp:TextBox ID="txtEventDate" runat="server" ReadOnly = "true"></asp:TextBox></td>
    </tr>
    <tr>
