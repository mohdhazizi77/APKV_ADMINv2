...
Public Class admin_reportKV
    ...
    Private Function getSQL() As String
        ...
        Dim strGroup As String = "group by kpmkv_kolej.Negeri,kpmkv_kolej.Kod,kpmkv_kolej.Nama,kpmkv_pelajar.Tahun"

        tmpSQL = " select kpmkv_kolej.Negeri,kpmkv_kolej.Kod,kpmkv_kolej.Nama,kpmkv_pelajar.Tahun,"
        tmpSQL += " count(*) total,"
