<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="kemaskini_kes_t.ascx.vb" Inherits="apkv_v2_admin.kemaskini_kes_t1" %>

<table class="fbform">
    <tr class="fbform_header">
        <td colspan="2">Kes T >> KEmaskini</td>
    </tr>
</table>
<br />
...
<table class="fbform">
    <tr class="fbform_header">
        <td colspan="6">Kemaskini Kes T</td>
    </tr>
    <tr>

        <td style="width: 200px">Pilihan:
        </td>

        <td>
            <asp:DropDownList ID="ddlKemaskini" runat="server" Width="100px" Enabled="true" AutoPostBack="true">
                <asp:ListItem Value="0">-Pilih-</asp:ListItem>
                <asp:ListItem Value="1">BM Setara</asp:ListItem>
                <asp:ListItem Value="2">Pentaksiran Berterusan Vokasional</asp:ListItem>
                <asp:ListItem Value="3">Pentaksiran Akhiran Vokasional</asp:ListItem>
            </asp:DropDownList>
        </td>
        ...
        <td>
            <asp:DropDownList ID="ddlPilihan" runat="server" Width="100px" Enabled="true"></asp:DropDownList>
        </td>
        <td>
