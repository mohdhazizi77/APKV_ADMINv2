<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="kelas.search.ascx.vb" Inherits="apkv_v2_admin.kelas_search" %>
<table class="fbform">
    <tr class="fbform_header">
        <td colspan="2">Carian Dan Penyelenggaraan >> Kelas</td>
    </tr>
</table>
<br />
<table class="fbform">
...
<table class="fbform">
    <tr class="fbform_header">
     ...
     <tr>
         ...
         <td>
            <asp:DropDownList ID="ddlTahun" runat="server" AutoPostBack="true" Width="350px">
            </asp:DropDownList>
        </td>
    <tr>
    <tr>
    ...
    <tr>
        <td colspan="2"><asp:Button ID="btnSearch" runat="server" Text="Cari " CssClass="fbbutton" />
        </td>
    </tr>
</table>
<br />
                ...
                <Columns>
                    <asp:TemplateField HeaderText="#">
                     ...
                     <asp:TemplateField HeaderText="Kolej">
                        <ItemTemplate>
                            <asp:Label ID="NamaKolej" runat="server" Text='<%# Bind("Nama")%>'></asp:Label>
                        </ItemTemplate>
