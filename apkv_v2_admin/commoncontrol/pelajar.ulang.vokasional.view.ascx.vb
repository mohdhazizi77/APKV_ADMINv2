...
Public Class pelajar_ulang_vokasional_view
    ...
    Private Sub Modul_Nama()
        ...
        '100
        strSQL = "SELECT KodModul+'-'+NamaModul AS Modul FROM kpmkv_modul WHERE KursusID='" & lblKursusID.Text & "' AND KodModul Like '%01%' and tahun='" & lblTahun.Text & "'and Semester='" & lblSemester.Text & "' and Sesi='" & lblSesi.Text & "' "
        strRet = oCommon.getFieldValue(strSQL)
        lblModul1.Text = strRet

        '200
        strSQL = " SELECT KodModul+'-'+NamaModul AS Modul FROM kpmkv_modul WHERE KursusID='" & lblKursusID.Text & "' AND KodModul Like '%02%' and tahun='" & lblTahun.Text & "'and Semester='" & lblSemester.Text & "' and Sesi='" & lblSesi.Text & "' "
        strRet = oCommon.getFieldValue(strSQL)
        lblModul2.Text = strRet

        '300
        strSQL = " SELECT KodModul+'-'+NamaModul AS Modul FROM kpmkv_modul WHERE KursusID='" & lblKursusID.Text & "' AND KodModul Like '%03%' and tahun='" & lblTahun.Text & "'and Semester='" & lblSemester.Text & "' and Sesi='" & lblSesi.Text & "' "
        strRet = oCommon.getFieldValue(strSQL)
        lblModul3.Text = strRet

        '400
        strSQL = " SELECT KodModul+'-'+NamaModul AS Modul FROM kpmkv_modul WHERE KursusID='" & lblKursusID.Text & "' AND KodModul Like '%04%' and tahun='" & lblTahun.Text & "'and Semester='" & lblSemester.Text & "' and Sesi='" & lblSesi.Text & "' "
        strRet = oCommon.getFieldValue(strSQL)
        lblModul4.Text = strRet

        '500
        strSQL = " SELECT KodModul+'-'+NamaModul AS Modul FROM kpmkv_modul WHERE KursusID='" & lblKursusID.Text & "' AND KodModul Like '%05%' and tahun='" & lblTahun.Text & "'and Semester='" & lblSemester.Text & "' and Sesi='" & lblSesi.Text & "' "
        strRet = oCommon.getFieldValue(strSQL)
        lblModul5.Text = strRet

        strSQL = " SELECT KodModul+'-'+NamaModul AS Modul FROM kpmkv_modul WHERE KursusID='" & lblKursusID.Text & "' AND KodModul Like '%06%' and tahun='" & lblTahun.Text & "'and Semester='" & lblSemester.Text & "' and Sesi='" & lblSesi.Text & "' "
        strRet = oCommon.getFieldValue(strSQL)
    ...
    Protected Sub btnApprove_Click(sender As Object, e As EventArgs) Handles btnApprove.Click
        ...
        If PB1.Checked = True Then
            ...
            Else
                ...
                strSQL += "VALUES('" & Request.QueryString("PelajarID") & "','" & lblKolejID.Text & "','" & lblPengajian.Text & "','" & ddlTahun.Text & "','" & lblSemester.Text & "','" & chkSesi.Text & "','" & lblKursusID.Text & "','" & ddlNamaKelas.SelectedValue & "','" & lblModul1.Text & "','1', '" & A_Teori1 & "')"
                strRet = oCommon.ExecuteSQL(strSQL)
            End If
        End If
        ...
        If PB9.Checked = True Then
            ...
            Else
                ...
                strSQL += "VALUES('" & Request.QueryString("PelajarID") & "','" & lblKolejID.Text & "','" & lblPengajian.Text & "','" & ddlTahun.Text & "','" & lblSemester.Text & "','" & chkSesi.Text & "','" & lblKursusID.Text & "','" & ddlNamaKelas.SelectedValue & "','" & lblModul1.Text & "','1','" & A_Amali1 & "')"
                strRet = oCommon.ExecuteSQL(strSQL)
            End If
        End If
        'm1------------------------------------------------------------------
        ...
        If PB2.Checked = True Then
            ...
            Else
                strSQL = "INSERT INTO kpmkv_pelajar_ulang_vokasional(PelajarID, KolejRecordID, Pengajian, Tahun, Semester, Sesi, KursusID, KelasID, NamaModul, PBTeori,MarkahPATeori)"
                strSQL += "VALUES('" & Request.QueryString("PelajarID") & "','" & lblKolejID.Text & "','" & lblPengajian.Text & "','" & ddlTahun.Text & "','" & lblSemester.Text & "','" & chkSesi.Text & "','" & lblKursusID.Text & "','" & ddlNamaKelas.SelectedValue & "','" & lblModul2.Text & "','1','" & A_Teori2 & "')"
                strRet = oCommon.ExecuteSQL(strSQL)
            End If
        End If
        ...
        If PB10.Checked = True Then
            ...
            Else
                strSQL = "INSERT INTO kpmkv_pelajar_ulang_vokasional(PelajarID, KolejRecordID, Pengajian, Tahun, Semester, Sesi, KursusID, KelasID, NamaModul, PBAmali,MarkahPAAmali)"
                strSQL += "VALUES('" & Request.QueryString("PelajarID") & "','" & lblKolejID.Text & "','" & lblPengajian.Text & "','" & ddlTahun.Text & "','" & lblSemester.Text & "','" & chkSesi.Text & "','" & lblKursusID.Text & "','" & ddlNamaKelas.SelectedValue & "','" & lblModul2.Text & "','1','" & A_Amali2 & "')"
                strRet = oCommon.ExecuteSQL(strSQL)
            End If
        End If
        'm2-----------------------------------
        ...
        If PB3.Checked = True Then
            ...
            Else
                strSQL = "INSERT INTO kpmkv_pelajar_ulang_vokasional(PelajarID, KolejRecordID, Pengajian, Tahun, Semester, Sesi, KursusID, KelasID, NamaModul, PBTeori,MarkahPATeori)"
                strSQL += "VALUES('" & Request.QueryString("PelajarID") & "','" & lblKolejID.Text & "','" & lblPengajian.Text & "','" & ddlTahun.Text & "','" & lblSemester.Text & "','" & chkSesi.Text & "','" & lblKursusID.Text & "','" & ddlNamaKelas.SelectedValue & "','" & lblModul3.Text & "','1','" & A_Teori3 & "')"
                strRet = oCommon.ExecuteSQL(strSQL)
            End If
        End If
        ...
        If PB11.Checked = True Then
            ...
            Else
                strSQL = "INSERT INTO kpmkv_pelajar_ulang_vokasional(PelajarID, KolejRecordID, Pengajian, Tahun, Semester, Sesi, KursusID, KelasID, NamaModul, PBAmali,MarkahPAAmali)"
                strSQL += "VALUES('" & Request.QueryString("PelajarID") & "','" & lblKolejID.Text & "','" & lblPengajian.Text & "','" & ddlTahun.Text & "','" & lblSemester.Text & "','" & chkSesi.Text & "','" & lblKursusID.Text & "','" & ddlNamaKelas.SelectedValue & "','" & lblModul3.Text & "','1','" & A_Amali3 & "')"
                strRet = oCommon.ExecuteSQL(strSQL)
            End If
        End If
        'm3-------------------------------------------------------
        ...
        If PB4.Checked = True Then
            ...
            Else
                strSQL = "INSERT INTO kpmkv_pelajar_ulang_vokasional(PelajarID, KolejRecordID, Pengajian, Tahun, Semester, Sesi, KursusID, KelasID, NamaModul, PBTeori,MarkahPATeori)"
                strSQL += "VALUES('" & Request.QueryString("PelajarID") & "','" & lblKolejID.Text & "','" & lblPengajian.Text & "','" & ddlTahun.Text & "','" & lblSemester.Text & "','" & chkSesi.Text & "','" & lblKursusID.Text & "','" & ddlNamaKelas.SelectedValue & "','" & lblModul4.Text & "','1','" & A_Teori4 & "')"
                strRet = oCommon.ExecuteSQL(strSQL)
            End If
        End If
        ...
        If PB12.Checked = True Then
            ...
            Else
                strSQL = "INSERT INTO kpmkv_pelajar_ulang_vokasional(PelajarID, KolejRecordID, Pengajian, Tahun, Semester, Sesi, KursusID, KelasID, NamaModul, PBAmali,MarkahPAAmali)"
                strSQL += "VALUES('" & Request.QueryString("PelajarID") & "','" & lblKolejID.Text & "','" & lblPengajian.Text & "','" & ddlTahun.Text & "','" & lblSemester.Text & "','" & chkSesi.Text & "','" & lblKursusID.Text & "','" & ddlNamaKelas.SelectedValue & "','" & lblModul4.Text & "','1','" & A_Amali4 & "')"
                strRet = oCommon.ExecuteSQL(strSQL)
            End If
        End If
        'm4-----------------------------------------------------------
        ...
        If PB5.Checked = True Then
            ...
            Else
                strSQL = "INSERT INTO kpmkv_pelajar_ulang_vokasional(PelajarID, KolejRecordID, Pengajian, Tahun, Semester, Sesi, KursusID, KelasID, NamaModul, PBTeori,MarkahPATeori)"
                strSQL += "VALUES('" & Request.QueryString("PelajarID") & "','" & lblKolejID.Text & "','" & lblPengajian.Text & "','" & ddlTahun.Text & "','" & lblSemester.Text & "','" & chkSesi.Text & "','" & lblKursusID.Text & "','" & ddlNamaKelas.SelectedValue & "','" & lblModul5.Text & "','1','" & A_Teori5 & "')"
                strRet = oCommon.ExecuteSQL(strSQL)
            End If
        End If
        ...
        If PB13.Checked = True Then
            ...
            Else
                strSQL = "INSERT INTO kpmkv_pelajar_ulang_vokasional(PelajarID, KolejRecordID, Pengajian, Tahun, Semester, Sesi, KursusID, KelasID, NamaModul, PBAmali,MarkahPAAmali)"
                strSQL += "VALUES('" & Request.QueryString("PelajarID") & "','" & lblKolejID.Text & "','" & lblPengajian.Text & "','" & ddlTahun.Text & "','" & lblSemester.Text & "','" & chkSesi.Text & "','" & lblKursusID.Text & "','" & ddlNamaKelas.SelectedValue & "','" & lblModul5.Text & "','1','" & A_Amali5 & "')"
                strRet = oCommon.ExecuteSQL(strSQL)
            End If
        End If
        'm5------------------------------------------------------
        ...
        If PB6.Checked = True Then
            ...
            Else
                strSQL = "INSERT INTO kpmkv_pelajar_ulang_vokasional(PelajarID, KolejRecordID, Pengajian, Tahun, Semester, Sesi, KursusID, KelasID, NamaModul, PBTeori,MarkahPATeori)"
                strSQL += "VALUES('" & Request.QueryString("PelajarID") & "','" & lblKolejID.Text & "','" & lblPengajian.Text & "','" & ddlTahun.Text & "','" & lblSemester.Text & "','" & chkSesi.Text & "','" & lblKursusID.Text & "','" & ddlNamaKelas.SelectedValue & "','" & lblModul6.Text & "','1','" & A_Teori6 & "')"
                strRet = oCommon.ExecuteSQL(strSQL)
            End If
        End If
        ...
        If PB14.Checked = True Then
            ...
            Else
                strSQL = "INSERT INTO kpmkv_pelajar_ulang_vokasional(PelajarID, KolejRecordID, Pengajian, Tahun, Semester, Sesi, KursusID, KelasID, NamaModul, PBAmali,MarkahPAAmali)"
                strSQL += "VALUES('" & Request.QueryString("PelajarID") & "','" & lblKolejID.Text & "','" & lblPengajian.Text & "','" & ddlTahun.Text & "','" & lblSemester.Text & "','" & chkSesi.Text & "','" & lblKursusID.Text & "','" & ddlNamaKelas.SelectedValue & "','" & lblModul6.Text & "','1','" & A_Amali6 & "')"
                strRet = oCommon.ExecuteSQL(strSQL)
            End If
        End If
        'm6-------------------------------------------------------------------------
        ...
        If PB7.Checked = True Then
            ...
            Else
                strSQL = "INSERT INTO kpmkv_pelajar_ulang_vokasional(PelajarID, KolejRecordID, Pengajian, Tahun, Semester, Sesi, KursusID, KelasID, NamaModul, PBTeori,MarkahPATeori)"
                strSQL += "VALUES('" & Request.QueryString("PelajarID") & "','" & lblKolejID.Text & "','" & lblPengajian.Text & "','" & ddlTahun.Text & "','" & lblSemester.Text & "','" & chkSesi.Text & "','" & lblKursusID.Text & "','" & ddlNamaKelas.SelectedValue & "','" & lblmodul7.Text & "','1','" & A_Teori7 & "')"
                strRet = oCommon.ExecuteSQL(strSQL)
            End If
        End If
        ...
        If PB15.Checked = True Then
            ...
            Else
                strSQL = "INSERT INTO kpmkv_pelajar_ulang_vokasional(PelajarID, KolejRecordID, Pengajian, Tahun, Semester, Sesi, KursusID, KelasID, NamaModul, PBAmali,MarkahPAAmali)"
                strSQL += "VALUES('" & Request.QueryString("PelajarID") & "','" & lblKolejID.Text & "','" & lblPengajian.Text & "','" & ddlTahun.Text & "','" & lblSemester.Text & "','" & chkSesi.Text & "','" & lblKursusID.Text & "','" & ddlNamaKelas.SelectedValue & "','" & lblmodul7.Text & "','1','" & A_Amali7 & "')"
                strRet = oCommon.ExecuteSQL(strSQL)
            End If
        End If
        'm7------------------------------------------------------------------------------------
        ...
        If PA1.Checked = True Then
            ...
            Else
                ...
                strSQL += "VALUES('" & Request.QueryString("PelajarID") & "','" & lblKolejID.Text & "','" & lblPengajian.Text & "','" & ddlTahun.Text & "','" & lblSemester.Text & "','" & chkSesi.Text & "','" & lblKursusID.Text & "','" & ddlNamaKelas.SelectedValue & "','" & lblModul1.Text & "','1','" & B_Teori1 & "')"
                strRet = oCommon.ExecuteSQL(strSQL)
            End If
        End If
        If PA2.Checked = True Then
            ...
            Else
                strSQL = "INSERT INTO kpmkv_pelajar_ulang_vokasional(PelajarID, KolejRecordID, Pengajian, Tahun, Semester, Sesi, KursusID, KelasID, NamaModul, PATeori,MarkahPBTeori)"
                strSQL += "VALUES('" & Request.QueryString("PelajarID") & "','" & lblKolejID.Text & "','" & lblPengajian.Text & "','" & ddlTahun.Text & "','" & lblSemester.Text & "','" & chkSesi.Text & "','" & lblKursusID.Text & "','" & ddlNamaKelas.SelectedValue & "','" & lblModul2.Text & "','1','" & B_Teori2 & "')"
                strRet = oCommon.ExecuteSQL(strSQL)
            End If
        End If
        If PA3.Checked = True Then
            ...
            Else
                strSQL = "INSERT INTO kpmkv_pelajar_ulang_vokasional(PelajarID, KolejRecordID, Pengajian, Tahun, Semester, Sesi, KursusID, KelasID, NamaModul, PATeori,MarkahPBTeori)"
                strSQL += "VALUES('" & Request.QueryString("PelajarID") & "','" & lblKolejID.Text & "','" & lblPengajian.Text & "','" & ddlTahun.Text & "','" & lblSemester.Text & "','" & chkSesi.Text & "','" & lblKursusID.Text & "','" & ddlNamaKelas.SelectedValue & "','" & lblModul3.Text & "','1','" & B_Teori3 & "')"
                strRet = oCommon.ExecuteSQL(strSQL)
            End If
        End If
        If PA4.Checked = True Then
            ...
            Else
                strSQL = "INSERT INTO kpmkv_pelajar_ulang_vokasional(PelajarID, KolejRecordID, Pengajian, Tahun, Semester, Sesi, KursusID, KelasID, NamaModul, PATeori,MarkahPBTeori)"
                strSQL += "VALUES('" & Request.QueryString("PelajarID") & "','" & lblKolejID.Text & "','" & lblPengajian.Text & "','" & ddlTahun.Text & "','" & lblSemester.Text & "','" & chkSesi.Text & "','" & lblKursusID.Text & "','" & ddlNamaKelas.SelectedValue & "','" & lblModul4.Text & "','1','" & B_Teori4 & "')"
                strRet = oCommon.ExecuteSQL(strSQL)
            End If
        End If
        If PA5.Checked = True Then
            ...
            Else
                strSQL = "INSERT INTO kpmkv_pelajar_ulang_vokasional(PelajarID, KolejRecordID, Pengajian, Tahun, Semester, Sesi, KursusID, KelasID, NamaModul, PATeori,MarkahPBTeori)"
                strSQL += "VALUES('" & Request.QueryString("PelajarID") & "','" & lblKolejID.Text & "','" & lblPengajian.Text & "','" & ddlTahun.Text & "','" & lblSemester.Text & "','" & chkSesi.Text & "','" & lblKursusID.Text & "','" & ddlNamaKelas.SelectedValue & "','" & lblModul5.Text & "','1','" & B_Teori5 & "')"
                strRet = oCommon.ExecuteSQL(strSQL)
            End If
        End If
        If PA6.Checked = True Then
            ...
            Else
                strSQL = "INSERT INTO kpmkv_pelajar_ulang_vokasional(PelajarID, KolejRecordID, Pengajian, Tahun, Semester, Sesi, KursusID, KelasID, NamaModul, PATeori,MarkahPBTeori)"
                strSQL += "VALUES('" & Request.QueryString("PelajarID") & "','" & lblKolejID.Text & "','" & lblPengajian.Text & "','" & ddlTahun.Text & "','" & lblSemester.Text & "','" & chkSesi.Text & "','" & lblKursusID.Text & "','" & ddlNamaKelas.SelectedValue & "','" & lblModul6.Text & "','1','" & B_Teori6 & "')"
                strRet = oCommon.ExecuteSQL(strSQL)
            End If
        End If
        If PA7.Checked = True Then
            ...
            Else
                strSQL = "INSERT INTO kpmkv_pelajar_ulang_vokasional(PelajarID, KolejRecordID, Pengajian, Tahun, Semester, Sesi, KursusID, KelasID, NamaModul, PATeori,MarkahPBTeori)"
                strSQL += "VALUES('" & Request.QueryString("PelajarID") & "','" & lblKolejID.Text & "','" & lblPengajian.Text & "','" & ddlTahun.Text & "','" & lblSemester.Text & "','" & chkSesi.Text & "','" & lblKursusID.Text & "','" & ddlNamaKelas.SelectedValue & "','" & lblmodul7.Text & "','1','" & B_Teori7 & "')"
                strRet = oCommon.ExecuteSQL(strSQL)
            End If
        End If
        ...
        If PA9.Checked = True Then
            ...
            Else
                ...
                strSQL += "VALUES('" & Request.QueryString("PelajarID") & "','" & lblKolejID.Text & "','" & lblPengajian.Text & "','" & ddlTahun.Text & "','" & lblSemester.Text & "','" & chkSesi.Text & "','" & lblKursusID.Text & "','" & ddlNamaKelas.SelectedValue & "','" & lblModul1.Text & "','1','" & B_Amali1 & "')"
                strRet = oCommon.ExecuteSQL(strSQL)
            End If
        End If
        If PA10.Checked = True Then
            ...
            Else
                strSQL = "INSERT INTO kpmkv_pelajar_ulang_vokasional(PelajarID, KolejRecordID, Pengajian, Tahun, Semester, Sesi, KursusID, KelasID, NamaModul, PAAmali,MarkahPBAmali)"
                strSQL += "VALUES('" & Request.QueryString("PelajarID") & "','" & lblKolejID.Text & "','" & lblPengajian.Text & "','" & ddlTahun.Text & "','" & lblSemester.Text & "','" & chkSesi.Text & "','" & lblKursusID.Text & "','" & ddlNamaKelas.SelectedValue & "','" & lblModul2.Text & "','1','" & B_Amali2 & "')"
                strRet = oCommon.ExecuteSQL(strSQL)
            End If
        End If
        If PA11.Checked = True Then
            ...
            Else
                strSQL = "INSERT INTO kpmkv_pelajar_ulang_vokasional(PelajarID, KolejRecordID, Pengajian, Tahun, Semester, Sesi, KursusID, KelasID, NamaModul, PAAmali,MarkahPBAmali)"
                strSQL += "VALUES('" & Request.QueryString("PelajarID") & "','" & lblKolejID.Text & "','" & lblPengajian.Text & "','" & ddlTahun.Text & "','" & lblSemester.Text & "','" & chkSesi.Text & "','" & lblKursusID.Text & "','" & ddlNamaKelas.SelectedValue & "','" & lblModul3.Text & "','1','" & B_Amali3 & "')"
                strRet = oCommon.ExecuteSQL(strSQL)
            End If
        End If
        If PA12.Checked = True Then
            ...
            Else
                strSQL = "INSERT INTO kpmkv_pelajar_ulang_vokasional(PelajarID, KolejRecordID, Pengajian, Tahun, Semester, Sesi, KursusID, KelasID, NamaModul, PAAmali,MarkahPBAmali)"
                strSQL += "VALUES('" & Request.QueryString("PelajarID") & "','" & lblKolejID.Text & "','" & lblPengajian.Text & "','" & ddlTahun.Text & "','" & lblSemester.Text & "','" & chkSesi.Text & "','" & lblKursusID.Text & "','" & ddlNamaKelas.SelectedValue & "','" & lblModul4.Text & "','1','" & B_Amali4 & "')"
                strRet = oCommon.ExecuteSQL(strSQL)
            End If
        End If
        If PA13.Checked = True Then
            ...
            Else
                strSQL = "INSERT INTO kpmkv_pelajar_ulang_vokasional(PelajarID, KolejRecordID, Pengajian, Tahun, Semester, Sesi, KursusID, KelasID, NamaModul, PAAmali,MarkahPBAmali)"
                strSQL += "VALUES('" & Request.QueryString("PelajarID") & "','" & lblKolejID.Text & "','" & lblPengajian.Text & "','" & ddlTahun.Text & "','" & lblSemester.Text & "','" & chkSesi.Text & "','" & lblKursusID.Text & "','" & ddlNamaKelas.SelectedValue & "','" & lblModul5.Text & "','1','" & B_Amali5 & "')"
                strRet = oCommon.ExecuteSQL(strSQL)
            End If
        End If
        If PA14.Checked = True Then
            ...
            Else
                strSQL = "INSERT INTO kpmkv_pelajar_ulang_vokasional(PelajarID, KolejRecordID, Pengajian, Tahun, Semester, Sesi, KursusID, KelasID, NamaModul, PAAmali,MarkahPBAmali)"
                strSQL += "VALUES('" & Request.QueryString("PelajarID") & "','" & lblKolejID.Text & "','" & lblPengajian.Text & "','" & ddlTahun.Text & "','" & lblSemester.Text & "','" & chkSesi.Text & "','" & lblKursusID.Text & "','" & ddlNamaKelas.SelectedValue & "','" & lblModul6.Text & "','1','" & B_Amali6 & "')"
                strRet = oCommon.ExecuteSQL(strSQL)
            End If
        End If
        If PA15.Checked = True Then
            ...
            Else
                strSQL = "INSERT INTO kpmkv_pelajar_ulang_vokasional(PelajarID, KolejRecordID, Pengajian, Tahun, Semester, Sesi, KursusID, KelasID, NamaModul, PAAmali,MarkahPBAmali)"
                strSQL += "VALUES('" & Request.QueryString("PelajarID") & "','" & lblKolejID.Text & "','" & lblPengajian.Text & "','" & ddlTahun.Text & "','" & lblSemester.Text & "','" & chkSesi.Text & "','" & lblKursusID.Text & "','" & ddlNamaKelas.SelectedValue & "','" & lblmodul7.Text & "','1','" & B_Amali7 & "')"
                strRet = oCommon.ExecuteSQL(strSQL)
            End If
        End If
