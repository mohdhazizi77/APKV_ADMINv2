...
Public Class admin_reportNegeri
    ...
    Private Function getSQL() As String
        ...
        Dim strGroup As String = " GROUP BY kpmkv_kolej.Negeri,kpmkv_kolej.Kod,kpmkv_pelajar.Tahun"

        tmpSQL = " SELECT kpmkv_kolej.Negeri,kpmkv_kolej.Kod,kpmkv_pelajar.Tahun,"
        tmpSQL += " COUNT(*) total,"
