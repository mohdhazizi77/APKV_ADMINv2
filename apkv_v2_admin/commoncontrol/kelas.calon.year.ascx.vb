...
Public Class kelas_calon_year
    ...
    Private Sub kpmkv_kelas_list()
        ...
        strSQL += " WHERE kpmkv_kelas.KolejRecordID='" & ddlKolej.Text & "'  AND kpmkv_kelas.Tahun= '" & ddlTahun.SelectedValue & "' AND kpmkv_kelas.IsDeleted='N'"
    ...
    Private Function getSQL() As String
        ...
        Dim strOrder As String = " ORDER BY kpmkv_kolej.Nama,kpmkv_pelajar.Tahun, kpmkv_pelajar.Semester, kpmkv_pelajar.Sesi ASC"

        tmpSQL = "SELECT kpmkv_kolej.Nama AS NamaKolej, kpmkv_pelajar.PelajarID, kpmkv_pelajar.Tahun, kpmkv_pelajar.Semester, kpmkv_pelajar.Sesi, kpmkv_pelajar.Nama, kpmkv_pelajar.MYKAD, kpmkv_pelajar.AngkaGiliran, "
        ...
        strWhere = " WHERE kpmkv_pelajar.KolejRecordID='" & ddlKolej.Text & "' AND kpmkv_pelajar.IsDeleted='N'"
