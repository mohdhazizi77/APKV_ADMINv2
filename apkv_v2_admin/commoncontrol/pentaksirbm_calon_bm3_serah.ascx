<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="pentaksirbm_calon_bm3_serah.ascx.vb" Inherits="apkv_v2_admin.pentaksirbm_calon_bm3_serah1" %>

<table class="fbform">
    <tr class="fbform_header">
        <td colspan="2">Senarai Calon untuk Penghantaran Markah Ujian Bertutur Bahasa Melayu
</td>
    </tr>
</table>
            ...
            <asp:GridView ID="datRespondent" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Markah Elemen">
                        ...
                        <ItemTemplate>
                            [<asp:Label ID="Individu" runat="server" Width="30px" MaxLength="3" Text='<%# Bind("BM3_1")%>'></asp:Label>]
                            [<asp:Label ID="Kumpulan" runat="server" Width="30px" MaxLength="3" Text='<%# Bind("BM3_2")%>'></asp:Label>]
                        </ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Jumlah Markah">
                        <HeaderStyle HorizontalAlign="Center" />
                        <ItemTemplate>
                            <asp:Label ID="Jumlah" Enabled="false" runat="server" Width="30px" MaxLength="3" Text='<%# Bind("BM3_Total")%>'></asp:Label>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:TemplateField>
