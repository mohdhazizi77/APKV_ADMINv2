...
Public Class kemaskini_kes_t1
    ...
    Private Sub ddlKemaskini_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ddlKemaskini.SelectedIndexChanged

        If ddlKemaskini.SelectedValue = 0 Then

            ddlPilihan.Enabled = False

        ElseIf ddlKemaskini.SelectedValue = 1 Then

            ddlPilihan.Enabled = True

        ElseIf ddlKemaskini.SelectedValue = 2 Then

            ddlPilihan.Enabled = True

        ElseIf ddlKemaskini.SelectedValue = 3 Then
    ...
    Private Sub kpmkv_pilihan_list()

        ddlPilihan.Items.Clear()

        If ddlKemaskini.SelectedValue = 1 Then

            ddlPilihan.Items.Insert(0, "Kertas 1")
            ddlPilihan.Items.Insert(1, "Kertas 2")
        ...
        ElseIf ddlKemaskini.SelectedValue = 2 Then
            ...
            Select Case strRet
                Case "2"
                    ...
                    ddlPilihan.Items.Insert(0, "Teori 1")
                    ddlPilihan.Items.Insert(1, "Amali 1")
                    ddlPilihan.Items.Insert(2, "Teori 2")
                    ddlPilihan.Items.Insert(3, "Amali 2")
                ...
                Case "3"
                    ...
                    ddlPilihan.Items.Insert(2, "Teori 2")
                    ddlPilihan.Items.Insert(3, "Amali 2")
                    ddlPilihan.Items.Insert(4, "Teori 3")
                    ddlPilihan.Items.Insert(5, "Amali 3")
                ...
                Case "4"
                    ...
                    ddlPilihan.Items.Insert(4, "Teori 3")
                    ddlPilihan.Items.Insert(5, "Amali 3")
                    ddlPilihan.Items.Insert(6, "Teori 4")
                    ddlPilihan.Items.Insert(7, "Amali 4")
                ...
                Case "5"
                    ...
                    ddlPilihan.Items.Insert(6, "Teori 4")
                    ddlPilihan.Items.Insert(7, "Amali 4")
                    ddlPilihan.Items.Insert(8, "Teori 5")
                    ddlPilihan.Items.Insert(9, "Amali 5")
                ...
                Case "6"
                    ...
                    ddlPilihan.Items.Insert(8, "Teori 5")
                    ddlPilihan.Items.Insert(9, "Amali 5")
                    ddlPilihan.Items.Insert(10, "Teori 6")
                    ddlPilihan.Items.Insert(11, "Amali 6")
        ...
        ElseIf ddlKemaskini.SelectedValue = 3 Then
            ...
            ddlPilihan.Items.Insert(0, "Amali 1")
            ddlPilihan.Items.Insert(1, "Teori 1")
            ...
            If datRespondent.Rows.Count = 1 Then
                ...
                For i As Integer = 0 To datRespondent.Rows.Count - 1
                    ...
                    If ddlKemaskini.SelectedValue = 1 Then
                        ...
                        If ddlPilihan.SelectedValue = 0 Then
