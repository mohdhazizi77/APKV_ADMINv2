<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="slip_BM1104.ascx.vb" Inherits="apkv_v2_admin.slip_BM1104" %>
<table class="fbform">
    <tr class="fbform_header">
        <td colspan="2">Slip Pernyataan Keputusan BM1104</td>
    </tr>
</table>
...
<table class="fbform" style ="width:100%">
    <tr class="fbform_header">
        <td>Borang Kawalan Sijil Vokasional Malaysia (Pernyataan BM 1104)</td>
    </tr>
