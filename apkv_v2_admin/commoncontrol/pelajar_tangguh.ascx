<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="pelajar_tangguh.ascx.vb" Inherits="apkv_v2_admin.pelajar_tangguh1" %>
<table class="fbform">
...
<table class="fbform">
    ...
    <tr>
        ...
        <td colspan="2">
            <asp:Button ID="btnSearch" runat="server" Width="200px" Text="Cari " CssClass="fbbutton" /></td>
