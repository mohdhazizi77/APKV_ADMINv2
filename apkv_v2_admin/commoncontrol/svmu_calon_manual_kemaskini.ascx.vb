...
Public Class svmu_calon_manual_kemaskini
...
FROM kpmkv_svmu_calon WHERE svmu_calon_id = '" & strRet & "'"
    ...
    Private Sub btnProceed_Click(sender As Object, e As EventArgs) Handles btnProceed.Click
        ...
        Dim svmu_no_permohonan As String

        strPelajarID = AsciiSwitchWithMod(Request.QueryString("ID"), -19, -7)
        strsvmuID = AsciiSwitchWithMod(Request.QueryString("NO"), -19, -7)
        strRefNo = AsciiSwitchWithMod(Request.QueryString("RefNo"), -19, -7)

        strSQL = "SELECT svmu_no_permohonan FROM kpmkv_svmu_payment_request WHERE RefNo = '" & strRefNo & "'"
        svmu_no_permohonan = oCommon.getFieldValue(strSQL)
        ...
        If chkBM.Checked = True Then
            ...
            If Not strRet = "" Then
                ...
                strSQL = "  INSERT INTO kpmkv_svmu_calon
                        (svmu_id, Nama, TarikhLahir, Jantina, Bangsa, Agama, KolejID, KolejNama, Kohort, Alamat, Poskod, Bandar, Negeri, Telefon, Email, MataPelajaran, StatusMP, PusatPeperiksaanID, TahunPeperiksaan, Status, create_timestamp, RefNo, svmu_no_permohonan)
                        VALUES
                        ('" & strsvmuID & "', '" & txtNama.Text & "', '" & txtDate.Text & "', '" & txtJantina.Text & "', '" & ddlBangsa.Text & "', '" & txtAgama.Text & "', '" & txtKolej.Text & "', '" & txtKolej.Text & "', '" & txtKohort.Text & "', '" & txtAlamat.Text & "', '" & txtPoskod.Text & "', '" & txtBandar.Text & "', '" & ddlNegeri.Text & "', '" & txtTelefon.Text & "', '" & txtEmail.Text & "', 'BM', '1', '" & PusatPeperiksaanID & "', '" & TahunPeperiksaan & "', 'BELUM DISAHKAN', CURRENT_TIMESTAMP, '" & strRefNo & "', '" & svmu_no_permohonan & "')"
            ...
            Else
                ...
                strSQL = "  INSERT INTO kpmkv_svmu_calon
                        (svmu_id, Nama, TarikhLahir, Jantina, Bangsa, Agama, KolejID, KolejNama, Kohort, Alamat, Poskod, Bandar, Negeri, Telefon, Email, MataPelajaran, StatusMP, PusatPeperiksaanID, TahunPeperiksaan, Status, create_timestamp, RefNo, svmu_no_permohonan)
                        VALUES
                        ('" & strsvmuID & "', '" & txtNama.Text & "', '" & txtDate.Text & "', '" & txtJantina.Text & "', '" & ddlBangsa.Text & "', '" & txtAgama.Text & "', '" & txtKolej.Text & "', '" & txtKolej.Text & "', '" & txtKohort.Text & "', '" & txtAlamat.Text & "', '" & txtPoskod.Text & "', '" & txtBandar.Text & "', '" & ddlNegeri.Text & "', '" & txtTelefon.Text & "', '" & txtEmail.Text & "', 'BM', '1', '" & ddlKolej.SelectedValue & "', '" & TahunPeperiksaan & "', 'BELUM DISAHKAN', CURRENT_TIMESTAMP, '" & strRefNo & "', '" & svmu_no_permohonan & "')"
                strRet = oCommon.ExecuteSQL(strSQL)
        ...
        If chkSJ.Checked = True Then
            ...
            If Not strRet = "" Then
                ...
                strSQL = "  INSERT INTO kpmkv_svmu_calon
                        (svmu_id, Nama, TarikhLahir, Jantina, Bangsa, Agama, KolejID, KolejNama, Kohort, Alamat, Poskod, Bandar, Negeri, Telefon, Email, MataPelajaran, StatusMP, PusatPeperiksaanID, TahunPeperiksaan, Status, create_timestamp, RefNo, svmu_no_permohonan)
                        VALUES
                        ('" & strsvmuID & "', '" & txtNama.Text & "', '" & txtDate.Text & "', '" & txtJantina.Text & "', '" & ddlBangsa.Text & "', '" & txtAgama.Text & "', '" & txtKolej.Text & "', '" & txtKolej.Text & "', '" & txtKohort.Text & "', '" & txtAlamat.Text & "', '" & txtPoskod.Text & "', '" & txtBandar.Text & "', '" & ddlNegeri.Text & "', '" & txtTelefon.Text & "', '" & txtEmail.Text & "', 'SJ', '1', '" & PusatPeperiksaanID & "', '" & TahunPeperiksaan & "', 'BELUM DISAHKAN', CURRENT_TIMESTAMP, '" & strRefNo & "', '" & svmu_no_permohonan & "')"
                strRet = oCommon.ExecuteSQL(strSQL)
            ...
            Else
                ...
                strSQL = "  INSERT INTO kpmkv_svmu_calon
                        (svmu_id, Nama, TarikhLahir, Jantina, Bangsa, Agama, KolejID, KolejNama, Kohort, Alamat, Poskod, Bandar, Negeri, Telefon, Email, MataPelajaran, StatusMP, PusatPeperiksaanID, TahunPeperiksaan, Status, create_timestamp, RefNo, svmu_no_permohonan)
                        VALUES
                        ('" & strsvmuID & "', '" & txtNama.Text & "', '" & txtDate.Text & "', '" & txtJantina.Text & "', '" & ddlBangsa.Text & "', '" & txtAgama.Text & "', '" & txtKolej.Text & "', '" & txtKolej.Text & "', '" & txtKohort.Text & "', '" & txtAlamat.Text & "', '" & txtPoskod.Text & "', '" & txtBandar.Text & "', '" & ddlNegeri.Text & "', '" & txtTelefon.Text & "', '" & txtEmail.Text & "', 'SJ', '1', '" & ddlKolej.SelectedValue & "', '" & TahunPeperiksaan & "', 'BELUM DISAHKAN', CURRENT_TIMESTAMP, '" & strRefNo & "', '" & svmu_no_permohonan & "')"
                strRet = oCommon.ExecuteSQL(strSQL)
        ...
        Response.Redirect("svmu_calon_manual_kemaskini.aspx?ID=" & AsciiSwitchWithMod(strPelajarID, 19, 7) & "&NO=" & AsciiSwitchWithMod(strsvmuID, 19, 7) & "&RefNo=" & AsciiSwitchWithMod(strRefNo, 19, 7))
