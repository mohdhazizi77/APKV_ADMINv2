...
Public Class pentaksirbm_j_reset_markah1
    ...
    Private Sub btnCari_Click(sender As Object, e As EventArgs) Handles btnCari.Click
        ...
        If Not txtCarian.Text = "" Then
            ...
            strSQL = "SELECT Negeri FROM kpmkv_users WHERE LoginID = '" & Session("LoginID") & "' AND Pwd = '" & Session("Password") & "'"
            Dim Negeri As String = oCommon.getFieldValue(strSQL)

            strSQL = "  SELECT kpmkv_pentaksir_bmsetara_calon.AngkaGiliran, kpmkv_pentaksir_bmsetara_calon.MYKAD, kpmkv_pentaksir_bmsetara_calon.Nama, kpmkv_pentaksir_bmsetara_calon.KolejRecordID FROM kpmkv_pentaksir_bmsetara_calon
                        LEFT JOIN kpmkv_kolej ON kpmkv_kolej.RecordID = kpmkv_pentaksir_bmsetara_calon.KolejRecordID
                        WHERE 
                        kpmkv_kolej.Negeri = '" & Negeri & "'
