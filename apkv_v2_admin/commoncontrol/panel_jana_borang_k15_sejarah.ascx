<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="panel_jana_borang_k15_sejarah.ascx.vb" Inherits="apkv_v2_admin.panel_jana_borang_k15_sejarah1" %>
<table class="fbform">
            ...
            <asp:GridView ID="datRespondent" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="SJ">
                        <ItemTemplate>
                            <asp:TextBox ID="txtSJ" runat="server" Width="30px" MaxLength="3" Text='<%# Bind("Kertas1") %>'></asp:TextBox>
                        </ItemTemplate>
...
<table class="fbform">
    <tr class="fbform_header">
        <td colspan="2">
            <asp:Button ID="btnPrint" runat="server" Text="Cetak Borang Markah" CssClass="fbbutton" /></td>
