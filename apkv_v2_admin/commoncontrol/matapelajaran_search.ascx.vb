...
Public Class matapelajaran_search
    ...
    Private Sub datRespondent_RowDeleting(sender As Object, e As GridViewDeleteEventArgs) Handles datRespondent.RowDeleting
        ...
        Dim strMataPelajaranID As Integer = datRespondent.DataKeys(e.RowIndex).Values("MataPelajaranID")
        Try
            If Not strMataPelajaranID = Session("MataPelajaranID") Then
                strSQL = "DELETE FROM kpmkv_matapelajaran WHERE MataPelajaranID='" & strMataPelajaranID & "'"
