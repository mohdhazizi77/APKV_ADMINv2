...
Public Class svmu_calon_manual_daftar
...
FROM kpmkv_svmu_calon WHERE svmu_calon_id = '" & strRet & "'"
    ...
    Private Sub btnBack_Click(sender As Object, e As EventArgs) Handles btnBack.Click
        Response.Redirect("svmu_calon_manual.aspx")
    End Sub
    ...
    Private Sub btnProceed_Click(sender As Object, e As EventArgs) Handles btnProceed.Click
        ...
        If chkBM.Checked = True Then
            ...
            If Not strRet = "" Then
                ...
                strSQL = "  INSERT INTO kpmkv_svmu_calon
                        (svmu_id, svmu_no_permohonan, Nama, TarikhLahir, Jantina, Bangsa, Agama, KolejID, KolejNama, Kohort, Alamat, Poskod, Bandar, Negeri, Telefon, Email, MataPelajaran, StatusMP, PusatPeperiksaanID, TahunPeperiksaan, Status, JenisDaftar, create_timestamp)
                        VALUES
                        ('" & strsvmuID & "', '" & formatNPKekal + formatNPTahunPeperiksaan + npAkhir.ToString("D" & 6) & "', '" & txtNama.Text & "', '" & txtDate.Text & "', '" & txtJantina.Text & "', '" & ddlBangsa.Text & "', '" & txtAgama.Text & "', '" & txtKolej.Text & "', '" & txtKolej.Text & "', '" & txtKohort.Text & "', '" & txtAlamat.Text & "', '" & txtPoskod.Text & "', '" & txtBandar.Text & "', '" & ddlNegeri.Text & "', '" & txtTelefon.Text & "', '" & txtEmail.Text & "', 'BM', '1', '" & PusatPeperiksaanID & "', '" & TahunPeperiksaan & "', 'BELUM DISAHKAN', 'MANUAL', CURRENT_TIMESTAMP)"
                strRet = oCommon.ExecuteSQL(strSQL)
            ...
            Else
                ...
                strSQL = "  INSERT INTO kpmkv_svmu_calon
                        (svmu_id, svmu_no_permohonan, Nama, TarikhLahir, Jantina, Bangsa, Agama, KolejID, KolejNama, Kohort, Alamat, Poskod, Bandar, Negeri, Telefon, Email, MataPelajaran, StatusMP, PusatPeperiksaanID, TahunPeperiksaan, Status, JenisDaftar, create_timestamp)
                        VALUES
                        ('" & strsvmuID & "', '" & formatNPKekal + formatNPTahunPeperiksaan + npAkhir.ToString("D" & 6) & "', '" & txtNama.Text & "', '" & txtDate.Text & "', '" & txtJantina.Text & "', '" & ddlBangsa.Text & "', '" & txtAgama.Text & "', '" & txtKolej.Text & "', '" & txtKolej.Text & "', '" & txtKohort.Text & "', '" & txtAlamat.Text & "', '" & txtPoskod.Text & "', '" & txtBandar.Text & "', '" & ddlNegeri.Text & "', '" & txtTelefon.Text & "', '" & txtEmail.Text & "', 'BM', '1', '" & ddlKolej.SelectedValue & "', '" & TahunPeperiksaan & "', 'BELUM DISAHKAN', 'MANUAL', CURRENT_TIMESTAMP)"
                strRet = oCommon.ExecuteSQL(strSQL)
        ...
        If chkSJ.Checked = True Then
            ...
            If Not strRet = "" Then
                ...
                strSQL = "  INSERT INTO kpmkv_svmu_calon
                        (svmu_id, svmu_no_permohonan, svmu_no_permohonan, Nama, TarikhLahir, Jantina, Bangsa, Agama, KolejID, KolejNama, Kohort, Alamat, Poskod, Bandar, Negeri, Telefon, Email, MataPelajaran, StatusMP, PusatPeperiksaanID, TahunPeperiksaan, Status, JenisDaftar, create_timestamp)
                        VALUES
                        ('" & strsvmuID & "', '" & formatNPKekal + formatNPTahunPeperiksaan + npAkhir.ToString("D" & 6) & "', '" & txtNama.Text & "', '" & txtDate.Text & "', '" & txtJantina.Text & "', '" & ddlBangsa.Text & "', '" & txtAgama.Text & "', '" & txtKolej.Text & "', '" & txtKolej.Text & "', '" & txtKohort.Text & "', '" & txtAlamat.Text & "', '" & txtPoskod.Text & "', '" & txtBandar.Text & "', '" & ddlNegeri.Text & "', '" & txtTelefon.Text & "', '" & txtEmail.Text & "', 'SJ', '1', '" & PusatPeperiksaanID & "', '" & TahunPeperiksaan & "', 'BELUM DISAHKAN', 'MANUAL', CURRENT_TIMESTAMP)"
                strRet = oCommon.ExecuteSQL(strSQL)
            ...
            Else
                ...
                strSQL = "  INSERT INTO kpmkv_svmu_calon
                        (svmu_id, svmu_no_permohonan, Nama, TarikhLahir, Jantina, Bangsa, Agama, KolejID, KolejNama, Kohort, Alamat, Poskod, Bandar, Negeri, Telefon, Email, MataPelajaran, StatusMP, PusatPeperiksaanID, TahunPeperiksaan, Status, JenisDaftar, create_timestamp)
                        VALUES
                        ('" & strsvmuID & "', '" & formatNPKekal + formatNPTahunPeperiksaan + npAkhir.ToString("D" & 6) & "', '" & txtNama.Text & "', '" & txtDate.Text & "', '" & txtJantina.Text & "', '" & ddlBangsa.Text & "', '" & txtAgama.Text & "', '" & txtKolej.Text & "', '" & txtKolej.Text & "', '" & txtKohort.Text & "', '" & txtAlamat.Text & "', '" & txtPoskod.Text & "', '" & txtBandar.Text & "', '" & ddlNegeri.Text & "', '" & txtTelefon.Text & "', '" & txtEmail.Text & "', 'SJ', '1', '" & ddlKolej.SelectedValue & "', '" & TahunPeperiksaan & "', 'BELUM DISAHKAN', 'MANUAL', CURRENT_TIMESTAMP)"
                strRet = oCommon.ExecuteSQL(strSQL)
        ...
        If strRet = "0" Then
            ...
            lblMsg.Text = "Pendaftaran Berjaya"

        Else

            lblMsg.Text = "Pendaftaran Tidak Berjaya"
