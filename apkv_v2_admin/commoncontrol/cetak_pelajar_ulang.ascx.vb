...
Public Class cetak_pelajar_ulang
    ...
    Private Sub kpmkv_tahun_2_list()
        ...
        Try
            ...
            ddlTahun_Semasa.Items.Insert(0, "-PILIH-")
    ...
    Private Sub kpmkv_kelas_list()
        Dim txtKod As String = ""
        Dim txtTahun As String = ""

        If ddlKodKursus.SelectedValue = "-PILIH-" Then
            txtKod = ""
        Else
            txtKod = ddlKodKursus.SelectedValue
        End If

        If ddlTahun.SelectedValue = "-PILIH-" Then
            txtTahun = ""
        Else
            txtTahun = ddlTahun.SelectedValue
        End If
        ...
        strSQL += " WHERE kpmkv_kelas.KolejRecordID='" & ddlKolej.SelectedValue & "' AND kpmkv_kelas_kursus.KursusID= '" & txtKod & "' AND kpmkv_kursus.Tahun= '" & txtTahun & "' ORDER BY  kpmkv_kelas.NamaKelas"
        Dim strConn As String = ConfigurationManager.AppSettings("ConnectionString")
        Dim objConn As SqlConnection = New SqlConnection(strConn)
        Dim sqlDA As New SqlDataAdapter(strSQL, objConn)
    ...
    Private Function getSQL() As String
        ...
        tmpSQL = "  SELECT DISTINCT
                    ...
                    WHERE 
                    kpmkv_pelajar_ulang.KolejRecordID = '" & ddlKolej.Text & "'"
        ...
        Try
            ...
            For i As Integer = 0 To datRespondent.Rows.Count - 1
                ...
                If cb.Checked = True Then
                    ...
                    cell = New PdfPCell()
                    cetak = Environment.NewLine & ": " & ddlKolej.SelectedItem.Text
