...
Public Class inden_matapelajaran_akademik_negeri
    ...
    Private Function getSQL() As String
        ...
        strGroup = "    GROUP BY kpmkv_kolej.Negeri"
    ...
    Private Sub ExportToCSV(ByVal strQuery As String)
        ...
        Response.AddHeader("content-disposition", "attachment;filename=Matapelajaran_Akademik_Negeri_Tahun" & ddlTahun.Text & "_Semester" & ddlSemester.Text & ".csv")
        Response.Charset = ""
