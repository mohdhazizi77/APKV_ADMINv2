...
Public Class pentaksirbm_default
    ...
    Protected Sub btnLogin_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnLogin.Click
        Try
            ...
            ''--login name
            strSQL = "Select LoginID,pwd from kpmkv_users WHERE LoginID='" & oCommon.FixSingleQuotes(txtLoginID.Text) & "' AND StatusID='2' AND Pwd='" & oCommon.FixSingleQuotes(txtPwd.Text) & "' AND UserType = 'PENTAKSIR-BMSETARA'"
            If oCommon.isExist(strSQL) = True Then
                ...
                Session("UserGroupCodeADMINv2") = ar_user_login(0)
