...
Public Class pensyarah_update
    ...
    Private Sub kpmkv_jantina_list()
        strSQL = "SELECT Jantina FROM kpmkv_jantina  ORDER BY Jantina"
        Dim strConn As String = ConfigurationManager.AppSettings("ConnectionString")
        Dim objConn As SqlConnection = New SqlConnection(strConn)
    ...
    Private Sub kpmkv_agama_list()
        strSQL = "SELECT Agama FROM kpmkv_agama  ORDER BY Agama"
        Dim strConn As String = ConfigurationManager.AppSettings("ConnectionString")
        Dim objConn As SqlConnection = New SqlConnection(strConn)
        Dim sqlDA As New SqlDataAdapter(strSQL, objConn)
    ...
    Private Sub btnDelete_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnDelete.Click
        strSQL = "UPDATE kpmkv_pensyarah SET IsDeleted='Y' WHERE PensyarahID='" & Request.QueryString("PensyarahID") & "'"
        strRet = oCommon.ExecuteSQL(strSQL)
        If strRet = "0" Then
