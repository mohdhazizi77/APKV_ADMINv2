<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="kursus_import.ascx.vb" Inherits="apkv_v2_admin.kursus_import" %>
<table class="fbform">
    <tr class="fbform_header">
        <td colspan="2">Kemasukan Program
        </td>
    </tr>
    <tr>
        <td>Pilih Fail Excel:
    ...
    <tr>
        <td colspan="2">
            <asp:GridView ID="datRespondent" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                CellPadding="4" ForeColor="#333333" GridLines="None" DataKeyNames="TxnKursusID"
    ...
    <tr>
        <td>
            <asp:Button ID="btnApprove" runat="server" Text="Sahkan" CssClass="fbbutton" />&nbsp;<asp:Button
                ID="btnCancel" runat="server" Text="Batal" CssClass="fbbutton" />&nbsp;|<asp:LinkButton ID="lnkList" runat="server">Senarai Kursus</asp:LinkButton>
        </td>
    </tr>
    </table>
