<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="svmu_kemaskini_calon_ulang.ascx.vb" Inherits="apkv_v2_admin.svmu_kemaskini_calon_ulang1" %>
...
<table class="fbform" style="padding-right: 10px">
    ...
    <tr>
        ...
        <td style="width: 3px">:</td>
        <td colspan="6">
            <asp:TextBox ID="txtAlamat" runat="server" Width="100%"></asp:TextBox>
        </td>
    ...
    <tr>
        ...
        <td style="width: 3px">:</td>
        <td style="width: 150px">
            <asp:TextBox ID="txtPoskod" runat="server" Width="90%"></asp:TextBox>
        </td>

        <td style="width: 150px">Bandar*</td>
        <td style="width: 3px">:</td>
        <td style="width: 150px">
            <asp:TextBox ID="txtBandar" runat="server" Width="100%"></asp:TextBox>
        </td>
    ...
    <tr>
        ...
        <td style="width: 3px">:</td>
        <td style="width: 150px">
            <asp:DropDownList ID="ddlNegeri" runat="server" Width="100%"></asp:DropDownList>
        </td>

        <td style="width: 150px">No. Telefon (HP)*</td>
        <td style="width: 3px">:</td>
        <td style="width: 150px">
            <asp:TextBox ID="txtTelefon" runat="server" Width="100%"></asp:TextBox>
        </td>
...
<table class="fbform" style="padding-right: 10px">
    ...
    <tr>
        ...
        <td style="text-align: center">
            <asp:Label ID="lblGredBM" runat="server" Text="A+"></asp:Label></td>
    ...
    <tr>
        ...
        <td style="text-align: center">
            <asp:Label ID="lblGredSJ" runat="server" Text="B+"></asp:Label></td>
...
<table class="fbform" style="padding-right: 10px">
    ...
    <tr>
        ...
        <td style="width: 3px">:</td>
        <td>
            <asp:DropDownList ID="DropDownList1" runat="server" Width="250px"></asp:DropDownList></td>
    ...
    <tr>
        ...
        <td style="width: 3px">:</td>
        <td>
            <asp:DropDownList ID="ddlKolej" runat="server" Width="250px"></asp:DropDownList></td>
