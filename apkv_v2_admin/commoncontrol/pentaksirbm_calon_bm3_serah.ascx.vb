...
Public Class pentaksirbm_calon_bm3_serah1
    ...
    Private Sub btnBack_Click(sender As Object, e As EventArgs) Handles btnBack.Click
        ...
        Response.Redirect("pentaksirbm_calon_bm3.aspx?id=" & id)
        ...
        Try
            ...
            For i As Integer = 0 To datRespondent.Rows.Count - 1
                ...
                strSQL = "  UPDATE kpmkv_pentaksir_bmsetara_calon
                            SET
                            StatusHantarBM3_Pentaksir = 'TELAH HANTAR',
                            StatusHantarBM3_Pentaksir_timestamp = CURRENT_TIMESTAMP
    ...
    Private Function getSQL() As String
        ...
        strWhere = " WHERE KolejRecordID='" & KolejRecordID & "' AND Tahun ='" & Kohort & "' AND StatusBM3_1 = '1' AND StatusBM3_2 = '1' AND StatusHantarBM3_Pentaksir = 'BELUM HANTAR'"
