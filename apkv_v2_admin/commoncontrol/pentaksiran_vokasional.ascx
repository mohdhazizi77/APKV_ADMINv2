<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="pentaksiran_vokasional.ascx.vb" Inherits="apkv_v2_admin.pentaksiran_vokasional" %>
<table class="fbform">
...
<table class="fbform">
    <tr class="fbform_header">
        <td colspan="3">Tetapan Tahun Semasa Peperiksaan</td>
    </tr>
    <tr style="text-align: center;">
           <td style="width: 10%;">Tahun:<asp:DropDownList ID="ddlTahun_Semasa" runat="server" AutoPostBack="false" Width="53px" Height="17px">
         </asp:DropDownList>
         </td>
    </tr>
    <tr>
