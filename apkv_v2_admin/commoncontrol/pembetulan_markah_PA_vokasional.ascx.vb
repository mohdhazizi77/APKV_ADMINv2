...
Public Class pembetulan_markah_PA_vokasional
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If Not IsPostBack Then
                ...
                kpmkv_tahun_list()
                ddlTahun.SelectedItem.Text = "-Pilih-"
    ...
    Private Sub kpmkv_negeri_list()
        ...
        Try
            ...
            '--ALL
            ddlNegeri.Items.Add(New ListItem("-Pilih-", "-Pilih-"))
    ...
    Private Sub kpmkv_jenis_list()
        ...
        Try
            ...
            '--ALL
            ddlJenis.Items.Add(New ListItem("-Pilih-", "-Pilih-"))
    ...
    Private Sub kpmkv_kelas_list()
        strSQL = " SELECT Distinct kpmkv_kelas.NamaKelas, kpmkv_kelas.KelasID"
    ...
    Private Function getSQLAudit() As String
        ...
        tmpSQL = "  SELECT TOP(10)
					...
					LEFT JOIN kpmkv_kursus D ON D.KursusID = A.KursusID                  
                    WHERE
                    A.PelajarID = '" & strPelajarID & "'
                    AND A.Menu = 'PA VOKASIONAL'					
    ...
    Protected Sub btnUpdate_Click(sender As Object, e As EventArgs) Handles btnUpdate.Click
        ...
        If datRespondent.Rows.Count = 1 Then
            ...
            For i As Integer = 0 To datRespondent.Rows.Count - 1
                ...
                If nCount = 2 Then
                    strSQL = "UPDATE kpmkv_pelajar_markah SET  A_Amali1='" & txtMarkahAmali.Text & "', A_Amali2='" & txtMarkahAmali.Text & "',"
                    strSQL += " WHERE PelajarID='" & datRespondent.DataKeys(i).Value.ToString & "'"
                ElseIf nCount = 3 Then
                    strSQL = "UPDATE kpmkv_pelajar_markah SET  A_Amali1='" & txtMarkahAmali.Text & "', A_Amali2='" & txtMarkahAmali.Text & "',"
                    strSQL += " A_Amali3='" & txtMarkahAmali.Text & "'"
                    strSQL += " WHERE PelajarID='" & datRespondent.DataKeys(i).Value.ToString & "'"
                ElseIf nCount = 4 Then
                    strSQL = "UPDATE kpmkv_pelajar_markah SET  A_Amali1='" & txtMarkahAmali.Text & "', A_Amali2='" & txtMarkahAmali.Text & "',"
                    strSQL += " A_Amali3='" & txtMarkahAmali.Text & "', A_Amali4='" & txtMarkahAmali.Text & "'"
                    strSQL += " WHERE PelajarID='" & datRespondent.DataKeys(i).Value.ToString & "'"
                ElseIf nCount = 5 Then
                    strSQL = "UPDATE kpmkv_pelajar_markah SET  A_Amali1='" & txtMarkahAmali.Text & "', A_Amali2='" & txtMarkahAmali.Text & "',"
                    strSQL += " A_Amali3='" & txtMarkahAmali.Text & "', A_Amali4='" & txtMarkahAmali.Text & "'"
                    strSQL += " A_Amali5='" & txtMarkahAmali.Text & "'"
                    strSQL += " WHERE PelajarID='" & datRespondent.DataKeys(i).Value.ToString & "'"
                ElseIf nCount = 6 Then
                    strSQL = "UPDATE kpmkv_pelajar_markah SET  A_Amali1='" & txtMarkahAmali.Text & "', A_Amali2='" & txtMarkahAmali.Text & "',"
                    strSQL += " A_Amali3='" & txtMarkahAmali.Text & "', A_Amali4='" & txtMarkahAmali.Text & "',"
                    strSQL += " A_Amali5='" & txtMarkahAmali.Text & "', A_Amali6='" & txtMarkahAmali.Text & "'"
                    strSQL += " WHERE PelajarID='" & datRespondent.DataKeys(i).Value.ToString & "'"
                ElseIf nCount = 7 Then
                    strSQL = "UPDATE kpmkv_pelajar_markah SET  A_Amali1='" & txtMarkahAmali.Text & "', A_Amali2='" & txtMarkahAmali.Text & "',"
                    strSQL += " A_Amali3='" & txtMarkahAmali.Text & "', A_Amali4='" & txtMarkahAmali.Text & "',"
                    strSQL += " A_Amali5='" & txtMarkahAmali.Text & "', A_Amali6='" & txtMarkahAmali.Text & "',"
                    strSQL += " A_Amali7='" & txtMarkahAmali.Text & "'"
                    strSQL += " WHERE PelajarID='" & datRespondent.DataKeys(i).Value.ToString & "'"
                ElseIf nCount = 8 Then
                    strSQL = "UPDATE kpmkv_pelajar_markah SET  A_Amali1='" & txtMarkahAmali.Text & "', A_Amali2='" & txtMarkahAmali.Text & "',"
                    strSQL += " A_Amali3='" & txtMarkahAmali.Text & "', A_Amali4='" & txtMarkahAmali.Text & "',"
                    strSQL += " A_Amali5='" & txtMarkahAmali.Text & "', A_Amali6='" & txtMarkahAmali.Text & "',"
                    strSQL += " A_Amali7='" & txtMarkahAmali.Text & "', A_Amali8='" & txtMarkahAmali.Text & "'"
                    strSQL += " WHERE PelajarID='" & datRespondent.DataKeys(i).Value.ToString & "'"
                End If
                ...
                Else
                    ...
                    markahSelepas = txtMarkahAmali.Text
    ...
    Private Sub auditTrailsInsert(ByVal PelajarID As String, ByVal markahSebelum As String, ByVal markahSelepas As String, ByVal Jenis As String)
        ...
        If datRespondent.Rows.Count = 1 Then
            ...
            For i = 0 To datRespondent.Rows.Count - 1
                ...
                'strSQL = "SELECT ModulID FROM kpmkv_modul WHERE KodModul = '" & ddlModul.SelectedValue & "' AND Tahun = '" & ddlTahun.Text & "' AND Semester = '" & ddlSemester.Text & "'"
                ...
                If Jenis = "KEMASKINI" Then
                    ...
                    ( UserID, PelajarID, KursusID, dateTime, Tahun, Semester, Sesi, Menu, MarkahSebelum, MarkahSelepas, Catatan, Jenis )
                    VALUES
                    ( '" & UserID & "', '" & PelajarID & "', '" & strKursusID & "', GETDATE(), '" & Tahun & "', '" & Semester & "', '" & chkSesi.Text & "', 'PA VOKASIONAL', '" & markahSebelum & "', '" & markahSelepas & "', '" & Jenis & "', 'AMALI')"
                    strRet = oCommon.ExecuteSQL(strSQL)
                ...
                Else
                    ...
                    VALUES
                    ( '" & UserID & "', '" & PelajarID & "', '" & strKursusID & "', GETDATE(), '" & Tahun & "', '" & Semester & "', '" & chkSesi.Text & "', 'PA VOKASIONAL', '" & Jenis & "')"
                    strRet = oCommon.ExecuteSQL(strSQL)
    ...
    Private Function ValidateForm() As Boolean
        ...
        For i As Integer = 0 To datRespondent.Rows.Count - 1
            ...
            If Not txtMarkahAmali.Text.Length = 0 Then
                If oCommon.IsCurrency(txtMarkahAmali.Text) = False Then
                    Return False
                End If
                If CInt(txtMarkahAmali.Text) > 100 Then
                    Return False
                End If
            Else
                txtMarkahAmali.Text = "0"
            End If
    ...
    Private Sub Vokasional_markah()
        ...
        If datRespondent.Rows.Count = 1 Then
            ...
            For i As Integer = 0 To datRespondent.Rows.Count - 1
                ...
                strSQL = "SELECT KursusID FROM kpmkv_pelajar_markah WHERE PelajarID = '" & datRespondent.DataKeys(i).Value.ToString & "' AND Tahun='" & Tahun & "' AND Semester='" & ddlSemester.Text & "' AND Sesi='" & chkSesi.Text & "'"
                Dim KursusID As String = oCommon.getFieldValue(strSQL)

                strSQL = "SELECT KodModul from kpmkv_modul WHERE KursusID='" & KursusID & "' AND Tahun='" & Tahun & "' AND Semester='" & ddlSemester.Text & "' AND Sesi='" & chkSesi.Text & "' AND KodModul Like '%01%' "
                Dim strModul1 As String = oCommon.getFieldValue(strSQL) '1

                strSQL = "SELECT KodModul from kpmkv_modul WHERE KursusID='" & KursusID & "' AND Tahun='" & Tahun & "' AND Semester='" & ddlSemester.Text & "' AND Sesi='" & chkSesi.Text & "' AND KodModul Like '%02%' "
                Dim strModul2 As String = oCommon.getFieldValue(strSQL) '2

                strSQL = "SELECT KodModul from kpmkv_modul WHERE KursusID='" & KursusID & "' AND Tahun='" & Tahun & "' AND Semester='" & ddlSemester.Text & "' AND Sesi='" & chkSesi.Text & "' AND KodModul Like '%03%' "
                Dim strModul3 As String = oCommon.getFieldValue(strSQL) '3

                strSQL = "SELECT KodModul from kpmkv_modul WHERE KursusID='" & KursusID & "' AND Tahun='" & Tahun & "' AND Semester='" & ddlSemester.Text & "' AND Sesi='" & chkSesi.Text & "' AND KodModul Like '%04%' "
                Dim strModul4 As String = oCommon.getFieldValue(strSQL) '4

                strSQL = "SELECT KodModul from kpmkv_modul WHERE KursusID='" & KursusID & "' AND Tahun='" & Tahun & "' AND Semester='" & ddlSemester.Text & "' AND Sesi='" & chkSesi.Text & "' AND KodModul Like '%05%' "
                Dim strModul5 As String = oCommon.getFieldValue(strSQL) '5

                strSQL = "SELECT KodModul from kpmkv_modul WHERE KursusID='" & KursusID & "' AND Tahun='" & Tahun & "' AND Semester='" & ddlSemester.Text & "' AND Sesi='" & chkSesi.Text & "' AND KodModul Like '%06%' "
                Dim strModul6 As String = oCommon.getFieldValue(strSQL) '6

                strSQL = "SELECT KodModul from kpmkv_modul WHERE KursusID='" & KursusID & "' AND Tahun='" & Tahun & "' AND Semester='" & ddlSemester.Text & "' AND Sesi='" & chkSesi.Text & "' AND KodModul Like '%07%' "
                Dim strModul7 As String = oCommon.getFieldValue(strSQL) '7

                strSQL = "SELECT KodModul from kpmkv_modul WHERE KursusID='" & KursusID & "' AND Tahun='" & Tahun & "' AND Semester='" & ddlSemester.Text & "' AND Sesi='" & chkSesi.Text & "' AND KodModul Like '%08%' "
                ...
                strSQL = "Select PBAmali from kpmkv_modul Where KodModul= '" & strModul1 & "' AND KursusID='" & KursusID & "' AND Tahun='" & Tahun & "' AND Semester='" & ddlSemester.Text & "' AND Sesi='" & chkSesi.Text & "'"
                PBAmali1 = oCommon.getFieldValue(strSQL)

                strSQL = "Select PBTeori from kpmkv_modul Where KodModul= '" & strModul1 & "' AND KursusID='" & KursusID & "' AND Tahun='" & Tahun & "' AND Semester='" & ddlSemester.Text & "' AND Sesi='" & chkSesi.Text & "'"
                PBTeori1 = oCommon.getFieldValue(strSQL)

                strSQL = "Select PAAmali from kpmkv_modul Where KodModul= '" & strModul1 & "' AND KursusID='" & KursusID & "' AND Tahun='" & Tahun & "' AND Semester='" & ddlSemester.Text & "' AND Sesi='" & chkSesi.Text & "'"
                PAAmali1 = oCommon.getFieldValue(strSQL)

                strSQL = "Select PATeori from kpmkv_modul Where KodModul= '" & strModul1 & "' AND KursusID='" & KursusID & "' AND Tahun='" & Tahun & "' AND Semester='" & ddlSemester.Text & "' AND Sesi='" & chkSesi.Text & "'"
                ...
                If Not String.IsNullOrEmpty(strModul2) Then
                    ...
                    strSQL = "Select PBAmali from kpmkv_modul Where KodModul= '" & strModul2 & "' AND KursusID='" & KursusID & "' AND Tahun='" & Tahun & "' AND Semester='" & ddlSemester.Text & "' AND Sesi='" & chkSesi.Text & "'"
                    PBAmali2 = oCommon.getFieldValue(strSQL)

                    strSQL = "Select PBTeori from kpmkv_modul Where KodModul= '" & strModul2 & "' AND KursusID='" & KursusID & "' AND Tahun='" & Tahun & "' AND Semester='" & ddlSemester.Text & "' AND Sesi='" & chkSesi.Text & "'"
                    PBTeori2 = oCommon.getFieldValue(strSQL)

                    strSQL = "Select PAAmali from kpmkv_modul Where KodModul= '" & strModul2 & "' AND KursusID='" & KursusID & "' AND Tahun='" & Tahun & "' AND Semester='" & ddlSemester.Text & "' AND Sesi='" & chkSesi.Text & "'"
                    PAAmali2 = oCommon.getFieldValue(strSQL)

                    strSQL = "Select PATeori from kpmkv_modul Where KodModul= '" & strModul2 & "' AND KursusID='" & KursusID & "' AND Tahun='" & Tahun & "' AND Semester='" & ddlSemester.Text & "' AND Sesi='" & chkSesi.Text & "'"
                ...
                If Not String.IsNullOrEmpty(strModul3) Then
                    ...
                    strSQL = "Select PBAmali from kpmkv_modul Where KodModul= '" & strModul3 & "' AND KursusID='" & KursusID & "' AND Tahun='" & Tahun & "' AND Semester='" & ddlSemester.Text & "' AND Sesi='" & chkSesi.Text & "'"
                    PBAmali3 = oCommon.getFieldValue(strSQL)

                    strSQL = "Select PBTeori from kpmkv_modul Where KodModul= '" & strModul3 & "' AND KursusID='" & KursusID & "' AND Tahun='" & Tahun & "' AND Semester='" & ddlSemester.Text & "' AND Sesi='" & chkSesi.Text & "'"
                    PBTeori3 = oCommon.getFieldValue(strSQL)

                    strSQL = "Select PAAmali from kpmkv_modul Where KodModul= '" & strModul3 & "' AND KursusID='" & KursusID & "' AND Tahun='" & Tahun & "' AND Semester='" & ddlSemester.Text & "' AND Sesi='" & chkSesi.Text & "'"
                    PAAmali3 = oCommon.getFieldValue(strSQL)

                    strSQL = "Select PATeori from kpmkv_modul Where KodModul= '" & strModul3 & "' AND KursusID='" & KursusID & "' AND Tahun='" & Tahun & "' AND Semester='" & ddlSemester.Text & "' AND Sesi='" & chkSesi.Text & "'"
                ...
                If Not String.IsNullOrEmpty(strModul4) Then
                    ...
                    strSQL = "Select PBAmali from kpmkv_modul Where KodModul= '" & strModul4 & "' AND KursusID='" & KursusID & "' AND Tahun='" & Tahun & "' AND Semester='" & ddlSemester.Text & "' AND Sesi='" & chkSesi.Text & "'"
                    PBAmali4 = oCommon.getFieldValue(strSQL)

                    strSQL = "Select PBTeori from kpmkv_modul Where KodModul= '" & strModul4 & "' AND KursusID='" & KursusID & "' AND Tahun='" & Tahun & "' AND Semester='" & ddlSemester.Text & "' AND Sesi='" & chkSesi.Text & "'"
                    PBTeori4 = oCommon.getFieldValue(strSQL)

                    strSQL = "Select PAAmali from kpmkv_modul Where KodModul= '" & strModul4 & "' AND KursusID='" & KursusID & "' AND Tahun='" & Tahun & "' AND Semester='" & ddlSemester.Text & "' AND Sesi='" & chkSesi.Text & "'"
                    PAAmali4 = oCommon.getFieldValue(strSQL)

                    strSQL = "Select PATeori from kpmkv_modul Where KodModul= '" & strModul4 & "' AND KursusID='" & KursusID & "' AND Tahun='" & Tahun & "' AND Semester='" & ddlSemester.Text & "' AND Sesi='" & chkSesi.Text & "'"
                ...
                If Not String.IsNullOrEmpty(strModul5) Then
                    ...
                    strSQL = "Select PBAmali from kpmkv_modul Where KodModul= '" & strModul5 & "' AND KursusID='" & KursusID & "' AND Tahun='" & Tahun & "' AND Semester='" & ddlSemester.Text & "' AND Sesi='" & chkSesi.Text & "'"
                    PBAmali5 = oCommon.getFieldValue(strSQL)

                    strSQL = "Select PBTeori from kpmkv_modul Where KodModul= '" & strModul5 & "' AND KursusID='" & KursusID & "' AND Tahun='" & Tahun & "' AND Semester='" & ddlSemester.Text & "' AND Sesi='" & chkSesi.Text & "'"
                    PBTeori5 = oCommon.getFieldValue(strSQL)

                    strSQL = "Select PAAmali from kpmkv_modul Where KodModul= '" & strModul5 & "' AND KursusID='" & KursusID & "' AND Tahun='" & Tahun & "' AND Semester='" & ddlSemester.Text & "' AND Sesi='" & chkSesi.Text & "'"
                    PAAmali5 = oCommon.getFieldValue(strSQL)

                    strSQL = "Select PATeori from kpmkv_modul Where KodModul= '" & strModul5 & "' AND KursusID='" & KursusID & "' AND Tahun='" & Tahun & "' AND Semester='" & ddlSemester.Text & "' AND Sesi='" & chkSesi.Text & "'"
                ...
                If Not String.IsNullOrEmpty(strModul6) Then
                    ...
                    strSQL = "Select PBAmali from kpmkv_modul Where KodModul= '" & strModul6 & "' AND KursusID='" & KursusID & "' AND Tahun='" & Tahun & "' AND Semester='" & ddlSemester.Text & "' AND Sesi='" & chkSesi.Text & "'"
                    PBAmali6 = oCommon.getFieldValue(strSQL)

                    strSQL = "Select PBTeori from kpmkv_modul Where KodModul= '" & strModul6 & "' AND KursusID='" & KursusID & "' AND Tahun='" & Tahun & "' AND Semester='" & ddlSemester.Text & "' AND Sesi='" & chkSesi.Text & "'"
                    PBTeori6 = oCommon.getFieldValue(strSQL)

                    strSQL = "Select PAAmali from kpmkv_modul Where KodModul= '" & strModul6 & "' AND KursusID='" & KursusID & "' AND Tahun='" & Tahun & "' AND Semester='" & ddlSemester.Text & "' AND Sesi='" & chkSesi.Text & "'"
                    PAAmali6 = oCommon.getFieldValue(strSQL)

                    strSQL = "Select PATeori from kpmkv_modul Where KodModul= '" & strModul6 & "' AND KursusID='" & KursusID & "' AND Tahun='" & Tahun & "' AND Semester='" & ddlSemester.Text & "' AND Sesi='" & chkSesi.Text & "'"
                ...
                If Not String.IsNullOrEmpty(strModul7) Then
                    ...
                    strSQL = "Select PBAmali from kpmkv_modul Where KodModul= '" & strModul7 & "' AND KursusID='" & KursusID & "' AND Tahun='" & Tahun & "' AND Semester='" & ddlSemester.Text & "' AND Sesi='" & chkSesi.Text & "'"
                    PBAmali7 = oCommon.getFieldValue(strSQL)

                    strSQL = "Select PBTeori from kpmkv_modul Where KodModul= '" & strModul7 & "' AND KursusID='" & KursusID & "' AND Tahun='" & Tahun & "' AND Semester='" & ddlSemester.Text & "' AND Sesi='" & chkSesi.Text & "'"
                    PBTeori7 = oCommon.getFieldValue(strSQL)

                    strSQL = "Select PAAmali from kpmkv_modul Where KodModul= '" & strModul7 & "' AND KursusID='" & KursusID & "' AND Tahun='" & Tahun & "' AND Semester='" & ddlSemester.Text & "' AND Sesi='" & chkSesi.Text & "'"
                    PAAmali7 = oCommon.getFieldValue(strSQL)

                    strSQL = "Select PATeori from kpmkv_modul Where KodModul= '" & strModul7 & "' AND KursusID='" & KursusID & "' AND Tahun='" & Tahun & "' AND Semester='" & ddlSemester.Text & "' AND Sesi='" & chkSesi.Text & "'"
                ...
                If Not String.IsNullOrEmpty(strModul8) Then
                    ...
                    strSQL = "Select PBAmali from kpmkv_modul Where KodModul= '" & strModul8 & "' AND KursusID='" & KursusID & "' AND Tahun='" & Tahun & "' AND Semester='" & ddlSemester.Text & "' AND Sesi='" & chkSesi.Text & "'"
                    PBAmali8 = oCommon.getFieldValue(strSQL)

                    strSQL = "Select PBTeori from kpmkv_modul Where KodModul= '" & strModul8 & "' AND KursusID='" & KursusID & "' AND Tahun='" & Tahun & "' AND Semester='" & ddlSemester.Text & "' AND Sesi='" & chkSesi.Text & "'"
                    PBTeori8 = oCommon.getFieldValue(strSQL)

                    strSQL = "Select PAAmali from kpmkv_modul Where KodModul= '" & strModul8 & "' AND KursusID='" & KursusID & "' AND Tahun='" & Tahun & "' AND Semester='" & ddlSemester.Text & "' AND Sesi='" & chkSesi.Text & "'"
                    PAAmali8 = oCommon.getFieldValue(strSQL)

                    strSQL = "Select PATeori from kpmkv_modul Where KodModul= '" & strModul8 & "' AND KursusID='" & KursusID & "' AND Tahun='" & Tahun & "' AND Semester='" & ddlSemester.Text & "' AND Sesi='" & chkSesi.Text & "'"
    ...
    Protected Sub ddlJenis_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ddlJenis.SelectedIndexChanged
        kpmkv_kolej_list()
        ddlKolej.SelectedItem.Text = "-Pilih-"
    ...
    Private Sub ddlTahun_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ddlTahun.SelectedIndexChanged
        ...
        kpmkv_kodkursus_list()
        ddlKodKursus.SelectedItem.Text = "-Pilih-"

        kpmkv_kelas_list()
        ddlKelas.SelectedItem.Text = "-Pilih-"
