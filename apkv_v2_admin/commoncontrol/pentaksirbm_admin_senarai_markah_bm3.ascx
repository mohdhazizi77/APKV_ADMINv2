<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="pentaksirbm_admin_senarai_markah_bm3.ascx.vb" Inherits="apkv_v2_admin.pentaksirbm_admin_senarai_markah_bm3" %>

<table class="fbform">
    <tr class="fbform_header">
        <td colspan="2">Senarai Pentaksiran Markah BM Setara (Kertas 3)</td>
    </tr>
</table>
