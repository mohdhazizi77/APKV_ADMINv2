<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="pentaksiran_roster.ascx.vb" Inherits="apkv_v2_admin.pentaksiran_roster" %>
<table class="fbform">
...
<%--         <asp:Button ID="btnExport" runat="server" Text="Export " CssClass="fbbutton"/>&nbsp;--%>
            <asp:Button ID="btnPrint" runat="server" Text="Cetak Slip Roster" CssClass="fbbutton"
