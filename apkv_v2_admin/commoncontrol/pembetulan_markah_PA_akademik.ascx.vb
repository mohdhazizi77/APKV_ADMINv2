            ...
            For i As Integer = 0 To datRespondent.Rows.Count - 1
                ...
                If strNamaMP = "BAHASA MELAYU" Then
                    ...
                    If ddlSemester.Text = "1" Then
                        ...
                        'strSQL = "Select PB from kpmkv_matapelajaran Where KodMataPelajaran LIKE '%A03'+'" & strKodMP & "%' AND Tahun='" & Tahun & "'"
                        strSQL = "SELECT PB FROM kpmkv_aka_weightage WHERE Tahun='" & Tahun & "'"
                        BerterusanBM = oCommon.getFieldValue(strSQL)

                        'strSQL = "Select PA from kpmkv_matapelajaran Where KodMataPelajaran LIKE '%A03'+'" & strKodMP & "%' AND Tahun='" & Tahun & "'"
                ...
                ElseIf strNamaMP = "BAHASA INGGERIS" Then
                    ...
                    'strSQL = "Select PB from kpmkv_matapelajaran Where KodMataPelajaran LIKE '%A02'+'" & strKodMP & "%' AND Tahun='" & Tahun & "'"
                    strSQL = "SELECT PB FROM kpmkv_aka_weightage WHERE Tahun='" & Tahun & "'"
                    BerterusanBI = oCommon.getFieldValue(strSQL)

                    'strSQL = "Select PA from kpmkv_matapelajaran Where KodMataPelajaran LIKE '%A02'+'" & strKodMP & "%' AND Tahun='" & Tahun & "'"
                    strSQL = "SELECT PA FROM kpmkv_aka_weightage WHERE Tahun='" & Tahun & "'"
                ...
                ElseIf strNamaMP = "SAINS" Or strNamaMP = "SAINS UNTUK TEKNOLOGI" Or strNamaMP = "SAINS UNTUK PENGAJIAN SOSIAL" Then
                    ...
                    'strSQL = "Select PB from kpmkv_matapelajaran Where KodMataPelajaran LIKE '%A04'+'" & strKodMP & "%' AND Tahun='" & Tahun & "'"
                    strSQL = "SELECT PB FROM kpmkv_aka_weightage WHERE Tahun='" & Tahun & "'"
                    BerterusanSc = oCommon.getFieldValue(strSQL)

                    'strSQL = "Select PA from kpmkv_matapelajaran Where KodMataPelajaran LIKE '%A04'+'" & strKodMP & "%'AND Tahun='" & Tahun & "'"
                    strSQL = "SELECT PA FROM kpmkv_aka_weightage WHERE Tahun='" & Tahun & "'"
                ...
                ElseIf strNamaMP = "SEJARAH" Then
                    ...
                    'strSQL = "Select PB from kpmkv_matapelajaran Where KodMataPelajaran LIKE '%A05'+'" & strKodMP & "%' AND Tahun='" & Tahun & "'"
                    strSQL = "SELECT PB FROM kpmkv_aka_weightage WHERE Tahun='" & Tahun & "'"
                    BerterusanSJ = oCommon.getFieldValue(strSQL)

                    'strSQL = "Select PA from kpmkv_matapelajaran Where KodMataPelajaran LIKE '%A05'+'" & strKodMP & "%' AND Tahun='" & Tahun & "'"
                    strSQL = "SELECT PA FROM kpmkv_aka_weightage WHERE Tahun='" & Tahun & "'"
                ...
                ElseIf strNamaMP = "PENDIDIKAN ISLAM" Then
                    ...
                    'strSQL = "Select PB from kpmkv_matapelajaran Where KodMataPelajaran LIKE '%A06'+'" & strKodMP & "%' AND Tahun='" & Tahun & "'"
                    strSQL = "SELECT PB FROM kpmkv_aka_weightage WHERE Tahun='" & Tahun & "'"
                    BerterusanPI = oCommon.getFieldValue(strSQL)

                    'strSQL = "Select PA from kpmkv_matapelajaran Where KodMataPelajaran LIKE '%A06'+'" & strKodMP & "%' AND Tahun='" & Tahun & "'"
                    strSQL = "SELECT PA FROM kpmkv_aka_weightage WHERE Tahun='" & Tahun & "'"
                ...
                ElseIf strNamaMP = "PENDIDIKAN MORAL" Then
                    ...
                    'strSQL = "Select PB from kpmkv_matapelajaran Where KodMataPelajaran LIKE '%A07'+'" & strKodMP & "%' AND Tahun='" & Tahun & "'"
                    strSQL = "SELECT PB FROM kpmkv_aka_weightage WHERE Tahun='" & Tahun & "'"
                    BerterusanPM = oCommon.getFieldValue(strSQL)

                    'strSQL = "Select PA from kpmkv_matapelajaran Where KodMataPelajaran LIKE '%A07'+'" & strKodMP & "%' AND Tahun='" & Tahun & "'"
                    strSQL = "SELECT PA FROM kpmkv_aka_weightage WHERE Tahun='" & Tahun & "'"
