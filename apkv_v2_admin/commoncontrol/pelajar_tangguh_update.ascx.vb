...
Public Class pelajar_tangguh_update
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            If Not IsPostBack Then
                ...
                strSQL = "SELECT kpmkv_kolej.Nama,kpmkv_kolej.RecordID FROM kpmkv_kolej LEFT OUTER JOIN kpmkv_pelajar ON kpmkv_kolej.RecordID=kpmkv_pelajar.KolejRecordID  WHERE kpmkv_pelajar.PelajarID='" & oCommon.Decrypt(Request.QueryString("PelajarID").Trim()) & "'"
                lblKolej.Text = oCommon.getFieldValue(strSQL)
                strSQL = "SELECT kpmkv_kolej.RecordID FROM kpmkv_kolej LEFT OUTER JOIN kpmkv_pelajar ON kpmkv_kolej.RecordID=kpmkv_pelajar.KolejRecordID  WHERE kpmkv_pelajar.PelajarID='" & oCommon.Decrypt(Request.QueryString("PelajarID").Trim()) & "'"
    ...
    Private Sub LoadPage()
        ...
        strSQL += " WHERE kpmkv_pelajar.PelajarID='" & oCommon.Decrypt(Request.QueryString("PelajarID").Trim()) & "'"
        Dim strConn As String = ConfigurationManager.AppSettings("ConnectionString")
        Dim objConn As SqlConnection = New SqlConnection(strConn)
        Dim sqlDA As New SqlDataAdapter(strSQL, objConn)
    ...
    Private Function kpmkv_pelajar_create() As Boolean
        ...
        If strRet = "0" Then
            ...
            strSQL += " VALUES ('" & strPelajarID & "','" & lblRecordID.Text & "','" & strKursusID & "',"
