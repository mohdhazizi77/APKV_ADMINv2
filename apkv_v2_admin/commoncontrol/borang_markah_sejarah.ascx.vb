...
Public Class borang_markah_sejarah1
    ...
    Private Function getSQL() As String
        ...
        strWhere = " WHERE kpmkv_pelajar.IsDeleted='N' AND kpmkv_pelajar.StatusID='2' AND kpmkv_pelajar.IsCalon='1' "
        ...
        tmpSQL1 += " FROM kpmkv_pelajar_ulang LEFT OUTER JOIN kpmkv_pelajar ON kpmkv_pelajar.PelajarID = kpmkv_pelajar_ulang.PelajarID "
        tmpSQL1 += " AND kpmkv_pelajar.KolejRecordID = kpmkv_pelajar_ulang.KolejRecordID"
        strWhere1 = " WHERE kpmkv_pelajar_ulang.IsCalon='1' AND kpmkv_pelajar_ulang.Semester ='4' "
        strWhere1 += " AND kpmkv_pelajar_ulang.NamaMataPelajaran='SEJARAH'"
        '--kolej
        strWhere1 += " AND kpmkv_pelajar_ulang.KolejRecordID ='" & ddlKodPusat.SelectedValue & "'"
        '--tahun
        strWhere1 += " AND kpmkv_pelajar_ulang.IsBMTahun ='" & ddlTahun.Text & "'"
        '--sesi
        If Not chkSesi.Text = "" Then
    ...
    Private Sub CreatePDF(ByVal tableColumns As DataColumnCollection, ByVal tableRows As DataRowCollection)
        ...
        Try
            ...
            strSQL = "SELECT KodMataPelajaran FROM kpmkv_matapelajaran WHERE NamaMataPelajaran='SEJARAH' AND Tahun='" & ddlTahun.SelectedValue & "' AND Semester='4' "
