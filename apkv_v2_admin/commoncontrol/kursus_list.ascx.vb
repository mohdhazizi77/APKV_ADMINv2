...
Public Class kursus_list
    ...
    Private Sub kpmkv_kodkursus_list()
        ...
        strSQL += " ON kpmkv_kursus_kolej.KursusID = kpmkv_kursus.KursusID LEFT OUTER JOIN kpmkv_kluster "
        strSQL += " ON kpmkv_kursus.KlusterID = kpmkv_kluster.KlusterID"
        strSQL += " WHERE kpmkv_kursus.Tahun='" & ddlTahun.SelectedValue & "' AND kpmkv_kursus.Sesi='" & chkSesi.SelectedValue & "'  AND kpmkv_kluster.KlusterID='" & ddlNamaKluster.SelectedValue & "'"
    ...
    Private Function getSQL() As String
        ...
        strWhere = "  WHERE kpmkv_kursus_kolej.IsDeleted='N'"
