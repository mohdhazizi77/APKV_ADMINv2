...
Public Class rawmarkah_BMSetara
    ...
    Private Sub calculateBMSetara()
        ...
        For i As Integer = 0 To 10 - 1
            ...
            lblGred_BM1104 = datRespondent.Rows(i).FindControl("GRED_BM1104")
            ...
            ''A_BahasaMelayu1
            strSQL = "SELECT A_BahasaMelayu1 FROM kpmkv_pelajar_markah WHERE PelajarID = '" & strPelajarID & "'"
            lblK1.Text = oCommon.getFieldValue(strSQL)
            ...
            ''A_BahasaMelayu2
            strSQL = "SELECT A_BahasaMelayu2 FROM kpmkv_pelajar_markah WHERE PelajarID = '" & strPelajarID & "'"
            lblK2.Text = oCommon.getFieldValue(strSQL)
            ...
            lblK3_System.Text = oCommon.getFieldValue(strSQL)

            If lblK3_System.Text = "" Then

                lblK3_System.Text = "-"

            End If

            If Not lblK3_System.Text = "-" Then

                lblK3.Text = Math.Round(lblK3_System.Text * 0.4)
            ...
            If Not lblK1.Text = "-" And Not lblK2.Text = "-" And Not lblK3.Text = "-" Then

                Total.Text = Convert.ToInt32(lblK1.Text) + Convert.ToInt32(lblK2.Text) + Convert.ToInt32(lblK3.Text)
            ...
            If Not Total.Text = "-" Then
                ...
                lblSem4_PA.Text = Math.Round(Convert.ToInt32(Total.Text) * 0.25)
            ...
            strSQL = "SELECT TOP ( 1 ) Gred FROM  kpmkv_gred_bmsetara WHERE '" & lblPB_PA.Text & "' BETWEEN MarkahFrom AND MarkahTo AND Jenis='BMSETARA'"
    ...
    Private Sub printBMSetara(ByVal gv As GridView)
        ...
        Response.AddHeader("content-disposition", "attachment;filename=RawMarkahBMSetara-Tahun" & ddlTahun.Text & ".csv")
        Response.Charset = ""
