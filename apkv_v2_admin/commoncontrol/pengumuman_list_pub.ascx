<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="pengumuman_list_pub.ascx.vb" Inherits="apkv_v2_admin.pengumuman_list_pub" %>
    ...
    <tr>
        <td style="vertical-align: top;">
            <asp:GridView ID="datRespondent" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                ...
                CellPadding="3" ForeColor="Black" GridLines="Vertical" PageSize="5" DataKeyNames="PengumumanID"
