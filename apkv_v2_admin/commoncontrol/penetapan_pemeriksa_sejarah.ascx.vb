...
Public Class penetapan_pemeriksa_sejarah1
    ...
    Protected Sub btnSimpan_Click(sender As Object, e As EventArgs) Handles btnSimpan.Click
        ...
        Try
            strSQL = "INSERT INTO kpmkv_pemeriksa(NamaPemeriksa, UserID, Tahun, Semester, Sesi, KodKolej,Jenis) "
            strSQL += "VALUES ('" & oCommon.FixSingleQuotes(ddlPemeriksa.Text) & "','" & StrUserID & "','" & ddlTahun.Text & "','4','" & chkSesi.Text & "','" & strPusat & "','SEJARAH')"
            strRet = oCommon.ExecuteSQL(strSQL)
            If strRet = "0" Then
                divMsg.Attributes("class") = "info"
                lblmsg.Text = "Berjaya mendaftarkan Pemeriksa Sejarah."
            Else
    ...
    Private Function getSQL() As String
        ...
        tmpSQL += " kpmkv_pemeriksa.KodKolej FROM kpmkv_pemeriksa"
        strWhere = " WHERE kpmkv_pemeriksa.PemeriksaID IS NOT NULL AND Jenis='SEJARAH'"
    ...
    Private Sub btnFile_Click(sender As Object, e As EventArgs) Handles btnFile.Click
        ...
        Response.AppendHeader("Content-Disposition", "attachment; filename=IMPORT_PEMERIKSAAKADEMIK.xlsx")
        Response.TransmitFile(Server.MapPath("~/sample_data/IMPORT_PEMERIKSAAKADEMIK.xlsx"))
        Response.End()
    End Sub
    ...
    Private Function SaveSiteData1(ByVal SiteData As DataSet) As String
        ...
        Try
            ...
            For i As Integer = 0 To SiteData.Tables(0).Rows.Count - SiteData.Tables(0).Rows(i).Item("No")
                ...
                strSQL = "SELECT UserID FROM kpmkv_users WHERE Nama = '" & Nama & "' AND UserType = 'AKADEMIK-PEMERIKSA'"
                ...
                If UserID = "" Then
                    ...
                    strSQL += " VALUES ('" & RecordID & "', '" & LoginID & "', '" & Password & "', 'AKADEMIK-PEMERIKSA', '" & Nama & "', '" & MYKAD & "', '" & Negeri & "')"
        ...
        Try
            ...
            For i As Integer = 0 To SiteData.Tables(0).Rows.Count - SiteData.Tables(0).Rows(i).Item("No")
                ...
                If Not IsDBNull(SiteData.Tables(0).Rows(i).Item("Nama Pemeriksa")) Then
                    ...
                    strSQL = " SELECT UserID FROM kpmkv_users WHERE Nama = '" & NamaPemeriksa & "' AND UserType = 'AKADEMIK-PEMERIKSA'"
                    Dim UserID As String = oCommon.getFieldValue(strSQL)
    ...
    Private Function SaveSiteData2(ByVal SiteData As DataSet) As String
        ...
        Try
            ...
            For i As Integer = 0 To SiteData.Tables(0).Rows.Count - SiteData.Tables(0).Rows(i).Item("No")
                ...
                strSQL = "SELECT PemeriksaID FROM kpmkv_pemeriksa WHERE NamaPemeriksa = '" & NamaPemeriksa & "' AND UserID = '" & UserID & "' AND Tahun = '" & Tahun & "' AND  Semester = '" & Semester & "' AND Sesi = '" & Sesi & "' AND KodKolej = '" & KodKolej & "' AND KodKursus = '" & KodKursus & "' AND Jenis = 'SEJARAH'"

                If oCommon.getFieldValue(strSQL) = "" Then

                    strSQL = "INSERT INTO kpmkv_pemeriksa (NamaPemeriksa, UserID, Tahun, Semester, Sesi, KodKolej, KodKursus,Jenis) "
                    strSQL += " VALUES ('" & NamaPemeriksa & "', '" & UserID & "', '" & Tahun & "','" & Semester & "','" & Sesi & "','" & KodKolej & "', '" & KodKursus & "', 'SEJARAH')"
                    strRet = oCommon.ExecuteSQL(strSQL)
