...
Public Class modul_search
    ...
    Private Sub kpmkv_sesi_list()
        strSQL = "SELECT Sesi FROM kpmkv_sesi  ORDER BY Sesi"
        Dim strConn As String = ConfigurationManager.AppSettings("ConnectionString")
        Dim objConn As SqlConnection = New SqlConnection(strConn)
        Dim sqlDA As New SqlDataAdapter(strSQL, objConn)
    ...
    Private Sub kpmkv_kod_list()
        strSQL = "SELECT LEFT (KodModul,3) as KodModul FROM kpmkv_modul  GROUP BY KodModul"
        Dim strConn As String = ConfigurationManager.AppSettings("ConnectionString")
        Dim objConn As SqlConnection = New SqlConnection(strConn)
        Dim sqlDA As New SqlDataAdapter(strSQL, objConn)
    ...
    Private Function getSQL() As String
        ...
        '--Semester
        If Not ddlSemester.Text = "ALL" Then
            strWhere += " AND Semester= '" & ddlSemester.Text & "'"
        End If

        '--Semester
        If Not ddlSesi.Text = "ALL" Then
            strWhere += " AND Sesi= '" & ddlSesi.Text & "'"
        End If

        '--Kod
        If Not ddlKodModul.Text = "ALL" Then
            strWhere += " AND Kodmodul like '" & ddlKodModul.Text & "%'"
        End If
