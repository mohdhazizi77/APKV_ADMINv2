<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="kluster.list.ascx.vb" Inherits="apkv_v2_admin.kluster_list" %>
<table class="fbform">
    <tr class="fbform_header">
        <td colspan="3">Pendaftaran >> Kluster</td>
    </tr>
</table>
<br />
<table class="fbform">
    <tr class="fbform_header">
        <td colspan="2">Carian Bidang</td>
    </tr>
    <tr>
        <td>Nama Bidang:</td>
        <td>
...
<table class="fbform">
    ...
    <tr>
        <td><asp:Button ID="btnExecute" runat="server" Text="Import" CssClass="fbbutton" />&nbsp;
        </td>
    </tr>
</table>
