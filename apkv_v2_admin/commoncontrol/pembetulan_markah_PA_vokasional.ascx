<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="pembetulan_markah_PA_vokasional.ascx.vb" Inherits="apkv_v2_admin.pembetulan_markah_PA_vokasional" %>
...
<table class="fbform">
    <tr class="fbform_header">
        <td colspan="6">Masukkan Markah Untuk Pembetulan</td>
    </tr>
    <tr>
        <td style="width: 150px">Markah Pembetulan:
        </td>
        <td>
            <asp:TextBox ID="txtMarkahAmali" runat="server" MaxLength="3" Width="30px"></asp:TextBox>&nbsp;&nbsp;
