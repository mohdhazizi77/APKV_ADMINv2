<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="penetapan_pemeriksa_bmsetara.ascx.vb" Inherits="apkv_v2_admin.penetapan_pemeriksa_bmsetara" %>
<table class="fbform">
    <tr class="fbform_header">
        <td colspan="2">Pemeriksa>>Penetapan Pemeriksa >> Jana Penetapan Pemeriksa</td>
    </tr>
</table>
<br />
<table class="fbform">
...
<table class="fbform">
    ...
    <tr>
        <td>Kertas No</td>
        <td>
            <asp:CheckBoxList ID="chkKertas" runat="server" AutoPostBack="true" Width="349px" RepeatDirection="Horizontal">
                <asp:ListItem>1</asp:ListItem>
                <asp:ListItem>2</asp:ListItem>
            </asp:CheckBoxList>
    </tr>
