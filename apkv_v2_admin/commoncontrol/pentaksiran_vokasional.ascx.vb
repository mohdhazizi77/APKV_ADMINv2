...
Public Class pentaksiran_vokasional
    ...
    Private Sub kpmkv_negeri_list()
        strSQL = "SELECT Negeri FROM kpmkv_negeri ORDER BY Negeri ASC"
        Dim strConn As String = ConfigurationManager.AppSettings("ConnectionString")
        Dim objConn As SqlConnection = New SqlConnection(strConn)
    ...
    Private Sub kpmkv_kolej_list()
        strSQL = "SELECT Nama,RecordID FROM kpmkv_kolej WHERE Negeri='" & ddlNegeri.SelectedValue & "' "
        strSQL += " And Jenis='" & ddlJenis.SelectedValue & "' ORDER BY Nama"
        Dim strConn As String = ConfigurationManager.AppSettings("ConnectionString")
        Dim objConn As SqlConnection = New SqlConnection(strConn)
        Dim sqlDA As New SqlDataAdapter(strSQL, objConn)
    ...
    Private Sub kpmkv_kodkursus_list()
        ...
        strSQL += " WHERE kpmkv_kursus_kolej.KolejRecordID='" & ddlKolej.Text & "' AND kpmkv_kursus.Tahun='" & ddlTahun.SelectedValue & "' "
    ...
    Private Function getSQL() As String
        ...
        strWhere = " WHERE kpmkv_pelajar.IsDeleted='N' AND kpmkv_pelajar.StatusID='2' AND kpmkv_pelajar.KolejRecordID='" & ddlKolej.Text & "'"
        ...
        Try
            ...
            For i As Integer = 0 To datRespondent.Rows.Count - 1
                ...
                If cb.Checked = True Then
                    ...
                    Dim strKolejnama As String = ddlKolej.SelectedItem.Text

                    'kolejnegeri
                    'strSQL = "SELECT Negeri FROM kpmkv_kolej WHERE Nama='" & strKolejnama & "'"
                    Dim strKolejnegeri As String = ddlNegeri.SelectedItem.Text
                    ...
                    'BahasaMelayu
                    strSQL = "SELECT  KODMatapelajaran, NamaMataPelajaran,JamKredit FROM kpmkv_matapelajaran WHERE SUBSTRING(KodMataPelajaran,4,1)='" & ddlSemester.Text & "' AND NamaMataPelajaran='BAHASA MELAYU'"
                    ...
                    End If
                    strSQL = "SELECT  KODMatapelajaran, NamaMataPelajaran,JamKredit FROM kpmkv_matapelajaran WHERE SUBSTRING(KodMataPelajaran,4,1)='" & ddlSemester.Text & "' AND NamaMataPelajaran='BAHASA INGGERIS'"
                    strRet = oCommon.getFieldValueEx(strSQL)
                    ' ''--get Gred akademik info
                    ...
                    'MATHEMATIC
                    strSQL = "SELECT  KODMatapelajaran, NamaMataPelajaran,JamKredit FROM kpmkv_matapelajaran WHERE SUBSTRING(KodMataPelajaran,4,1)='" & ddlSemester.Text & "' AND NamaMataPelajaran='MATHEMATIC'"
                    strRet = oCommon.getFieldValueEx(strSQL)
                    ...
                    End If
                    'SCIENCE
                    strSQL = "SELECT  KODMatapelajaran, NamaMataPelajaran,JamKredit FROM kpmkv_matapelajaran WHERE SUBSTRING(KodMataPelajaran,4,1)='" & ddlSemester.Text & "' AND NamaMataPelajaran='SCIENCE'"
                    strRet = oCommon.getFieldValueEx(strSQL)
                    ...
                    End If
                    'SEJARAH
                    strSQL = "SELECT  KODMatapelajaran, NamaMataPelajaran,JamKredit FROM kpmkv_matapelajaran WHERE SUBSTRING(KodMataPelajaran,4,1)='" & ddlSemester.Text & "' AND NamaMataPelajaran='SEJARAH'"
                    strRet = oCommon.getFieldValueEx(strSQL)
                    ...
                    End If
                    'PENDIDIKAN ISLAM
                    strSQL = "SELECT  KODMatapelajaran, NamaMataPelajaran,JamKredit FROM kpmkv_matapelajaran WHERE SUBSTRING(KodMataPelajaran,4,1)='" & ddlSemester.Text & "' AND NamaMataPelajaran='PENDIDIKAN ISLAM'"
                    strRet = oCommon.getFieldValueEx(strSQL)
                    ...
                    End If
                    'PENDIDIKAN MORAL
                    strSQL = "SELECT  KODMatapelajaran, NamaMataPelajaran,JamKredit FROM kpmkv_matapelajaran WHERE SUBSTRING(KodMataPelajaran,4,1)='" & ddlSemester.Text & "' AND NamaMataPelajaran='PENDIDIKAN MORAL'"
                    strRet = oCommon.getFieldValueEx(strSQL)
                    ...
                    '' 07122020 MATAPELAJARAN VOKASIONAL-----------------------------------------------------
    ...
    Private Function myPara03() As Object
