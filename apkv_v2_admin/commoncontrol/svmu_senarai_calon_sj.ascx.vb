...
Public Class svmu_senarai_calon_sj
    ...
    Private Sub btnCetak_Click(sender As Object, e As EventArgs) Handles btnCetak.Click
        ...
        Try
            ...
            HttpContext.Current.Response.AddHeader("content-disposition", "attachment;filename=SenaraiCalonSVMU-SJ.pdf")
