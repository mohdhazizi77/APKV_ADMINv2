...
Public Class markah_bmsetara_kertas1
    ...
    Private Function getSQL() As String
        ...
        strSQL = "  SELECT 
                    ...
                    kpmkv_pelajar.AngkaGiliran,
                    kpmkv_pelajar.Mykad,
                    kpmkv_pelajar_markah.A_BahasaMelayu1 AS 'Kertas1',
                    kpmkv_pelajar_markah.Catatan AS 'Catatan1'
                    FROM 
                    kpmkv_pelajar
        ...
        '            AND kpmkv_pelajar.IsCalon = '1' 
        '            AND kpmkv_pelajar.Semester = '4' 
        '            AND kpmkv_markah_bmsj_setara.KolejRecordID = '" & lblKolejRecorID.Text & "' 
        '            AND kpmkv_markah_bmsj_setara.IsAKATahun = '" & lblTahun.Text & "' 
        '            AND kpmkv_markah_bmsj_setara.IsAKASesi = '" & lblSesi.Text & "' 
        '            AND kpmkv_markah_bmsj_setara.MataPelajaran = 'BAHASA MELAYU'
        '            ORDER BY kpmkv_pelajar.AngkaGiliran"
    ...
    Protected Sub btnUpdate_Click(sender As Object, e As EventArgs) Handles btnUpdate.Click
        ...
        Try
            ...
            For i As Integer = 0 To datRespondent.Rows.Count - 1
                ...
                Dim Catatan As TextBox = datRespondent.Rows(i).FindControl("Catatan1")

                'assign value to integer
                Dim BM3 As String = Kertas1.Text
                Dim strCatatan As String = Catatan.Text

                strSQL = "  UPDATE kpmkv_markah_bmsj_setara SET Kertas1 = '" & BM3 & "', Catatan1 = '" & strCatatan & "' 
    ...
    Protected Sub btnEksport_Click(sender As Object, e As EventArgs) Handles btnEksport.Click
        Try
            ...
            Dim myDataSet As New DataSet
            Dim myDataAdapter As New SqlDataAdapter(getSQL, strConn)
            myDataAdapter.Fill(myDataSet, "Borang Markah Kertas 1")
    ...
    Private Sub CreatePDF(ByVal tableColumns As DataColumnCollection, ByVal tableRows As DataRowCollection)
        ...
        Try
            ...
            msFileName = "Borang1" & oCommon.getRandom & ".pdf"
            KodBM = "A01401"
            ...
            Dim Cell4Hdr As New PdfPCell(New Phrase("KERTAS 1", FontFactory.GetFont("Arial", 9, Font.NORMAL)))
            ...
            For i As Integer = 0 To dt.Rows.Count - 1
                ...
                strSQL = "SELECT Kertas1 FROM kpmkv_markah_bmsj_setara WHERE PelajarID='" & dt.Rows(i)("PelajarID").ToString() & "' AND MataPelajaran = 'BAHASA MELAYU'"
                strKertas1 = oCommon.getFieldValue(strSQL)

                If strKertas1 = "" Then

                    strSQL = "SELECT A_BahasaMelayu1 FROM kpmkv_pelajar_markah WHERE PelajarID='" & dt.Rows(i)("PelajarID").ToString() & "'"
                    strKertas1 = oCommon.getFieldValue(strSQL)

                    strSQL = "SELECT Catatan FROM kpmkv_pelajar_markah WHERE PelajarID='" & dt.Rows(i)("PelajarID").ToString() & "'"
                    strCatatan = oCommon.getFieldValue(strSQL)

                Else

                    strSQL = "SELECT Catatan1 FROM kpmkv_markah_bmsj_setara WHERE PelajarID='" & dt.Rows(i)("PelajarID").ToString() & "' AND MataPelajaran = 'BAHASA MELAYU'"
                    strCatatan = oCommon.getFieldValue(strSQL)
