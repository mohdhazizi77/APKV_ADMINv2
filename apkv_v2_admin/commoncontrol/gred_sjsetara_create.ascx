<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="gred_sjsetara_create.ascx.vb" Inherits="apkv_v2_admin.gred_sjsetara_create1" %>

<table class="fbform">
    <tr class="fbform_header">
        <td colspan="2">Konfigurasi >> Gred SJ Setara >> Pendaftaran Baru</td>
    </tr>
</table>
<br />
<table class="fbform">
    <tr class="fbform_header">
        <td colspan="2">Paparan Maklumat Gred SJ Setara
        </td>
    </tr>
    <tr>
          <td>Kohort:</td>
    ...
    <tr>
        <td></td>
        <td><asp:Button ID="btnDaftar" runat="server" Text="Daftar Baru" CssClass="fbbutton" /> &nbsp;<asp:Button ID="btlist" runat="server" Text="Senarai Gred SJ Setara" CssClass="fbbutton" />
        </td>
    </tr>
