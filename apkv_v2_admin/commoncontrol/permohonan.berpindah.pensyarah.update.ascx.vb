...
Public Class permohonan_berpindah_pensyarah_update
    ...
    Dim DecryptStrKey As String = oCommon.Decrypt(Request.QueryString("PensyarahID").Trim())
    ...
    Private Sub kpmkv_jeniskolej_list()
        ...
        Try
            ...
            '--ALL
            ddlJenisKolej.Items.Add(New ListItem("PILIH", "0"))
        Catch ex As Exception
            lblMsg.Text = "System Error:" & ex.Message
    ...
    Private Sub kpmkv_namakolej_list()
        ...
        Try
            ...
            '--ALL
            ddlNamaKolej.Items.Add(New ListItem("PILIH", "0"))
        Catch ex As Exception
            lblMsg.Text = "System Error:" & ex.Message
    ...
    Private Sub LoadPage()
        ...
        strSQL += " WHERE kpmkv_pensyarah.IsDeleted='N' AND kpmkv_pensyarah.StatusID='2' AND kpmkv_pensyarah.PensyarahID='" & DecryptStrKey & "'"
    ...
    Private Sub btnUpdate_Click(sender As Object, e As EventArgs) Handles btnUpdate.Click
        ...
        Try
            ...
            Else
                strSQL = "UPDATE kpmkv_pensyarah SET KolejRecordID='" & lblKolejID.Text & "', DateTransfer='', RefNoTransfer='' WHERE PensyarahID='" & DecryptStrKey & "'"
                strRet = oCommon.ExecuteSQL(strSQL)

                strSQL = "Delete From kpmkv_pensyarah_history WHERE PensyarahID='" & DecryptStrKey & "' AND KolejRecordID='" & lblKolejID.Text & "'"
                strRet = oCommon.ExecuteSQL(strSQL)
    ...
    Private Function kpmkv_Pensyarah_history() As String
        ...
        strSQL += " DateCreated, CreateBy, IsDeleted, UploadCode, IsApproved, DateTransfer From kpmkv_pensyarah WHERE PensyarahID='" & DecryptStrKey & "'"
    ...
    Private Function kpmkv_pensyarah_update() As String
        'insert into course list
        strSQL = "UPDATE kpmkv_pensyarah SET KolejRecordID='" & ddlNamaKolej.SelectedValue & "', DateTransfer='" & Request.Form(txtEventDate.UniqueID) & "' WHERE PensyarahID='" & DecryptStrKey & "'"
        strRet = oCommon.ExecuteSQL(strSQL)
        ''--debug
        'Response.Write(SQL)
