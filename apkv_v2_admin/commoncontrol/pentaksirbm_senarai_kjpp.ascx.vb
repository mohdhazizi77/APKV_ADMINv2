...
Public Class pentaksirbm_senarai_kjpp
    ...
    Private Sub KolejList()

        strSQL = "SELECT Nama,RecordID FROM kpmkv_kolej WHERE Negeri='" & ddlNegeri.SelectedItem.Value & "' AND Jenis='KPM'"
        Dim strConn As String = ConfigurationManager.AppSettings("ConnectionString")
        Dim objConn As SqlConnection = New SqlConnection(strConn)
        Dim sqlDA As New SqlDataAdapter(strSQL, objConn)
    ...
    Private Sub TahunPeperiksaanList()
    ...
    Private Function getSQL() As String
        ...
        tmpSQL = "  SELECT kpmkv_pentaksir_bmsetara.id,
                    ...
                    ORDER BY kpmkv_kolej.Negeri, kpmkv_kolej.Nama"
