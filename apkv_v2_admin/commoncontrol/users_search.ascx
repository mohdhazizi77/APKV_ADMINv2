<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="users_search.ascx.vb" Inherits="apkv_v2_admin.users_search" %>
...
<table class="fbform">
    ...
    <tr>
        ...
        <td>
            <asp:TextBox ID="txtNama" runat="server" Width="350px"></asp:TextBox>
        </td>
