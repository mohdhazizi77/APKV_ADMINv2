<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="slip_roster_SJ1251.ascx.vb" Inherits="apkv_v2_admin.slip_roster_SJ12511" %>
<table class="fbform">
    <tr class="fbform_header">
        <td colspan="2">Jana Keseluruhan Matapelajaran Setara</td>
    </tr>
</table>
...
<table class="fbform">
    ...
    <tr>
        <td>
            <asp:Panel ID="pnlList" runat="server" ScrollBars="Vertical" Height="600px">
    ...
    <tr>
        <td>
            ...
            <asp:Button ID="btnPrint" runat="server" Text="Jana Gred" CssClass="fbbutton" />&nbsp;<asp:HyperLink ID="hyPDF" runat="server" Target="_blank"
                Visible="false">Klik disini untuk muat turun.</asp:HyperLink>
            <asp:Button ID="btnPrintKeseluruhan" runat="server" Text="Jana Gred Keseluruhan" CssClass="fbbutton" />
