...
Public Class pelajar_ulang_create
    ...
    Private Function getSQL() As String
        ...
        strWhere = " WHERE kpmkv_pelajar_markah.KolejRecordID='" & ddlKolej.SelectedValue & "' and kpmkv_pelajar.IsDeleted='N' and kpmkv_pelajar.StatusID='2'"
        strWhere += " AND (kpmkv_pelajar_markah.GredV1  IN ('D','E','D-','D+','T')"
        strWhere += " OR kpmkv_pelajar_markah.GredV2  IN ('D','E','D-','D+','T')"
        strWhere += " OR kpmkv_pelajar_markah.GredV3  IN ('D','E','D-','D+','T')"
        strWhere += " OR kpmkv_pelajar_markah.GredV4  IN ('D','E','D-','D+','T')"
        strWhere += " OR kpmkv_pelajar_markah.GredV5  IN ('D','E','D-','D+','T')"
        strWhere += " OR kpmkv_pelajar_markah.GredV6  IN ('D','E','D-','D+','T')"
        strWhere += " OR kpmkv_pelajar_markah.GredV7  IN ('D','E','D-','D+','T')"
        strWhere += " OR kpmkv_pelajar_markah.GredV8  IN ('D','E','D-','D+','T'))"
