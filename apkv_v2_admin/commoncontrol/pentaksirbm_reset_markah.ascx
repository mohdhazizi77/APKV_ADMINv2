<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="pentaksirbm_reset_markah.ascx.vb" Inherits="apkv_v2_admin.pentaksirbm_reset_markah" %>

<table class="fbform">
    <tr class="fbform_header">
        <td colspan="2">Reset Markah Penilaian Calon oleh Pentaksir</td>
    </tr>
</table>
