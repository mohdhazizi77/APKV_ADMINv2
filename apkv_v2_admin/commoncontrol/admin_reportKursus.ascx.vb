...
Public Class admin_reportKursus
    ...
    Private Sub kpmkv_kodkursus_list()
        ...
        strSQL += " WHERE Tahun='" & ddlTahun.SelectedValue & "' GROUP BY KodKursus ORDER BY KodKursus ASC"
        Dim strConn As String = ConfigurationManager.AppSettings("ConnectionString")
        Dim objConn As SqlConnection = New SqlConnection(strConn)
        Dim sqlDA As New SqlDataAdapter(strSQL, objConn)
    ...
    Private Function getSQL() As String
        ...
        Dim strGroup As String = " group by kpmkv_kolej.Kod,kpmkv_kolej.Negeri,kpmkv_kolej.Nama,kpmkv_kursus.KodKursus,kpmkv_pelajar.Tahun,kpmkv_pelajar.Sesi"
        Dim strOrder As String = " ORDER BY kpmkv_kolej.Kod,kpmkv_kolej.Negeri,kpmkv_kolej.Nama,kpmkv_kursus.KodKursus,kpmkv_pelajar.Tahun,kpmkv_pelajar.Sesi ASC"

        tmpSQL = " select kpmkv_kolej.Kod,kpmkv_kolej.Negeri,kpmkv_kolej.Nama, kpmkv_kursus.KodKursus,kpmkv_pelajar.Tahun,kpmkv_pelajar.Sesi,"
        tmpSQL += " count(*) total,"
