...
Public Class modul_pensyarah_create
    ...
    Private Sub kpmkv_kolej_list()
        strSQL = "SELECT Nama,RecordID FROM kpmkv_kolej  WHERE RecordID=(SELECT Distinct KolejRecordID from kpmkv_kolej_kursus)ORDER BY Nama"
        Dim strConn As String = ConfigurationManager.AppSettings("ConnectionString")
        Dim objConn As SqlConnection = New SqlConnection(strConn)
    ...
    Private Function getSQL() As String
        ...
        ElseIf Not txtKod.Text.Length = 0 Then
            tmpSQL = "SELECT * FROM kpmkv_pensyarah"
            strWhere = "  WHERE IsDeleted='N'AND KolejRecordID=(Select RecordID From kpmkv_kolej where Nama LIKE '%" & oCommon.FixSingleQuotes(txtKod.Text) & "%')"
        End If
    ...
    Private Sub tbl_menu_check()
        ...
        For i As Integer = 0 To datRespondent.Rows.Count - 1
            ...
            strSQL = "Select * from kpmkv_modul_pensyarah where NamaPensyarah='" & str & "' and Tahun='" & lblTahun.Text & "' and KodModul='" & lblKod.Text & "' and KolejRecordID='" & KolejRecord & "'"
            ...
            For i As Integer = 0 To datRespondent.Rows.Count - 1
                ...
                If isChecked Then
                    ...
                    If oCommon.isExist(strSQL) = False Then
                        strSQL = "INSERT INTO kpmkv_modul_pensyarah (KolejRecordID,NamaKluster,Tahun,KodKursus,NamaKursus,Semester,Sesi,KodModul,NamaModul,JamKredit,NamaPensyarah)"
