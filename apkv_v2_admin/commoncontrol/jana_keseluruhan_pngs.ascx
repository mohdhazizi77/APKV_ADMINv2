<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="jana_keseluruhan_pngs.ascx.vb" Inherits="apkv_v2_admin.jana_keseluruhan_pngs1" %>
<table class="fbform">
...
<table class="fbform">
    ...
    <tr>
        <td>
          ...
          <asp:Button ID="btnGredKeseluruhan" runat="server" Text="Jana PNGS Negeri" CssClass="fbbutton" Visible="true" />
        </td>
    </tr>
</table>
