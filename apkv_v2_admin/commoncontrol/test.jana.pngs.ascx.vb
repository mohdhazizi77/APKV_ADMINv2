...
Public Class test_jana_pngs1
    ...
    Private Sub kpmkv_tahun_list()
        ...
        Dim strCon As String = ConfigurationManager.AppSettings("ConnectionString")
        ...
        sqlCom.CommandText = "ddlTahun"

        sqlCon.Open()

        ddlTahun.DataSource = sqlCom.ExecuteReader
    ...
    Private Sub kpmkv_negeri_list()
        ...
        Try
            ...
            sqlCom.Connection = sqlCon
            sqlCom.CommandType = CommandType.StoredProcedure
            sqlCom.CommandText = "ddlNegeri"

            sqlCon.Open()

            ddlNegeri.DataSource = sqlCom.ExecuteReader
    ...
    Private Sub kpmkv_jenis_list()
        ...
        Try
            ...
            sqlCom.Connection = sqlCon
            sqlCom.CommandType = CommandType.StoredProcedure
            sqlCom.CommandText = "ddlJenis"

            sqlCon.Open()

            ddlJenis.DataSource = sqlCom.ExecuteReader
    ...
    Private Sub kpmkv_kolej_list()
        ...
        Try
            ...
            param(0) = New SqlParameter("@ddlNegeri", ddlNegeri.Text)
            param(1) = New SqlParameter("@ddlJenis", ddlJenis.Text)
            ...
            sqlCom.Connection = sqlCon
            sqlCom.CommandType = CommandType.StoredProcedure
            sqlCom.CommandText = "ddlKolej"

            sqlCom.Parameters.AddRange(param)

            sqlCon.Open()

            ddlKolej.DataSource = sqlCom.ExecuteReader
    ...
    Private Sub kpmkv_semester_list()
        ...
        Try
            ...
            sqlCom.Connection = sqlCon
            sqlCom.CommandType = CommandType.StoredProcedure
            sqlCom.CommandText = "ddlSemester"

            sqlCon.Open()

            ddlSemester.DataSource = sqlCom.ExecuteReader
    ...
    Private Sub ddlNegeri_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ddlNegeri.SelectedIndexChanged
        ...
        kpmkv_jenis_list()
        ddlJenis.SelectedValue = "-Pilih-"

        ddlKolej.SelectedValue = "-Pilih-"
    End Sub
