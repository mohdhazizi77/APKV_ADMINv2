<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="markah.vokasional.list.ascx.vb" Inherits="apkv_v2_admin.markah_vokasional_list" %>
<table class="fbform">
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Kursus4">
                     ...
                     <asp:TemplateField HeaderText="Jumlah">
                        <ItemTemplate>
                            <asp:Label ID="SMP_Total" runat="server" Width="10px" Text='<%# Bind("SMP_Total")%>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
