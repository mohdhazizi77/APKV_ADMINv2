<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="muatturun.bahan.ascx.vb" Inherits="apkv_v2_admin.muatturun_bahan1" %>
...
<Columns>
    ...
    <asp:TemplateField HeaderText="Tarikh Mula">
            <ItemTemplate>
                <asp:Label ID="Label1" runat="server" Text='<%# Bind("STarikh")%>'></asp:Label>
            </ItemTemplate>
            <HeaderStyle HorizontalAlign="Left" VerticalAlign="Top" /><ItemStyle VerticalAlign="Middle" />
        </asp:TemplateField>
    <asp:TemplateField HeaderText="Tarikh Tamat">
            <ItemTemplate>
                <asp:Label ID="Label2" runat="server" Text='<%# Bind("ETarikh")%>'></asp:Label>
            </ItemTemplate>
            <HeaderStyle HorizontalAlign="Left" VerticalAlign="Top" /><ItemStyle VerticalAlign="Middle" />
        </asp:TemplateField>
            <asp:TemplateField HeaderText="Kohort">
            <ItemTemplate>
                <asp:Label ID="Label3" runat="server" Text='<%# Bind("Kohort")%>'></asp:Label>
            </ItemTemplate>
            <HeaderStyle HorizontalAlign ="Center"  VerticalAlign="Top" /><ItemStyle VerticalAlign="Middle" HorizontalAlign ="Center" />
        </asp:TemplateField>
            ...
            <asp:TemplateField HeaderText="Sesi">
            <ItemTemplate>
                <asp:Label ID="Label5" runat="server" Text='<%# Bind("Sesi")%>'></asp:Label>
            </ItemTemplate>
            <HeaderStyle HorizontalAlign ="Center"  VerticalAlign="Top" /><ItemStyle VerticalAlign="Middle" HorizontalAlign ="Center"  />
        </asp:TemplateField>
        ...
        <asp:TemplateField HeaderText="Tajuk">
            <ItemTemplate>
                <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("Tajuk")%>' TextMode="MultiLine" Width="250px" Enabled ="false" ></asp:TextBox>
            </ItemTemplate>
            <HeaderStyle HorizontalAlign="Left" VerticalAlign="Top" /><ItemStyle VerticalAlign="Middle" />
        </asp:TemplateField>
            <asp:TemplateField HeaderText="Catatan">
            <ItemTemplate>
                 <asp:TextBox ID="TextBox2" runat="server" Text='<%# Bind("Catatan")%>' TextMode="MultiLine" Width="250px" Enabled ="false" ></asp:TextBox>
            </ItemTemplate>
            <HeaderStyle HorizontalAlign="Left" VerticalAlign="Top" /><ItemStyle VerticalAlign="Middle" />
        </asp:TemplateField>
