<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="pernyataan_keputusan_BM.ascx.vb" Inherits="apkv_v2_admin.pernyataan_keputusan_BM" %>
<table class="fbform">
...
<%--         <asp:Button ID="btnExport" runat="server" Text="Export " CssClass="fbbutton"/>&nbsp;--%>
            <asp:Button ID="btnPrint" runat="server" Text="Cetak Pernyataan Keputusan" CssClass="fbbutton"
