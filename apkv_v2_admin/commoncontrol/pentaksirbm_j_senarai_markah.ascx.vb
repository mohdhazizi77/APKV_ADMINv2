...
Public Class pentaksirbm_j_senarai_markah
    ...
    Private Sub datRespondent_SelectedIndexChanging(sender As Object, e As GridViewSelectEventArgs) Handles datRespondent.SelectedIndexChanging
        ...
        If MataPelajaran = "BAHASA MELAYU 3" Then
            ...
            Response.Redirect("pentaksirbm_j_senarai_markah_bm3.aspx?id=" & strKey)

        Else

            Response.Redirect("pentaksirbm_j_senarai_markah_bm4.aspx?id=" & strKey)
    ...
    Private Function getSQL() As String
        ...
        tmpSQL = "  SELECT kpmkv_pentaksir_bmsetara.id,
                    ...
                    WHERE kpmkv_kolej.Negeri = '" & Negeri & "'"
