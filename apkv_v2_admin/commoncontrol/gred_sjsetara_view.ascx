<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="gred_sjsetara_view.ascx.vb" Inherits="apkv_v2_admin.gred_sjsetara_view1" %>
...
<table class="fbform">
    <tr class="fbform_header">
        <td colspan="3">Paparan Maklumat Gred SJ Setara</td>
    </tr>
    <tr>
          <td>Tahun:</td>
