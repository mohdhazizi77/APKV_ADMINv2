<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="sijil_vok_malaysia.ascx.vb" Inherits="apkv_v2_admin.sijil_vok_malaysia1" %>
<table class="fbform">
    <tr class="fbform_header">
        <td colspan="2">Sijil Vokasional Malaysia</td>
    </tr>
</table>
