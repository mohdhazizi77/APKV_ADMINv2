...
Public Class wajaranakademik_view
        ...
        Try
            ...
            If MyTable.Rows.Count > 0 Then
                ...
                If Not IsDBNull(ds.Tables(0).Rows(0).Item("Berterusan")) Then
                    lblBerterusan.Text = ds.Tables(0).Rows(0).Item("Berterusan")
                Else
                    lblBerterusan.Text = ""
                End If

                If Not IsDBNull(ds.Tables(0).Rows(0).Item("Akhir")) Then
                    lblAkhir.Text = ds.Tables(0).Rows(0).Item("Akhir")
                Else
                    lblAkhir.Text = ""
                End If
    ...
    Protected Sub btnExecute_Click(sender As Object, e As EventArgs) Handles btnExecute.Click
        ...
        Response.Redirect("wajaranakademik.update.aspx?WajaranID=" & Request.QueryString("WajaranID"))
    End Sub
End Class