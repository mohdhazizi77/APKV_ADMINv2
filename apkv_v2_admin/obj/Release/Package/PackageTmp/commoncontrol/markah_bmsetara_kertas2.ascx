<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="markah_bmsetara_kertas2.ascx.vb" Inherits="apkv_v2_admin.markah_bmsetara_kertas2" %>
<table class="fbform">
    <tr class="fbform_header">
        <td colspan="2">Pemeriksa&gt;&gt;Markah &gt;&gt;Markah BM Setara Kertas 2</td>
    </tr>
</table>
<br />
       ...
       <td>
            <asp:GridView ID="datRespondent" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Kertas 2">
                        <ItemTemplate>
                            <asp:TextBox ID="Kertas2" runat="server" Width="30px" Text='<%# Bind("Kertas2")%>'></asp:TextBox>
                        </ItemTemplate>
                    </asp:TemplateField>
                     <asp:TemplateField HeaderText="Catatan">
                        <ItemTemplate>
                            <asp:TextBox ID="Catatan2" runat="server" Width="30px" Text='<%# Bind("Catatan2")%>'></asp:TextBox>
                        </ItemTemplate>
                    </asp:TemplateField>
