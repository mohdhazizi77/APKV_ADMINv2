<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="markah_PA_sejarah.ascx.vb" Inherits="apkv_v2_admin.markah_PA_sejarah1" %>
<table class="fbform">
    <tr class="fbform_header">
        <td colspan="2">Akademik>>Pemeriksa>>Markah PA Sejarah</td>
    </tr>
</table>
<br />
...
<asp:Label ID="lblTahun" runat="server" Text="" Visible="false"></asp:Label>
    <asp:Label ID ="lblSjTahun" runat ="server" visible="false" ></asp:Label>
