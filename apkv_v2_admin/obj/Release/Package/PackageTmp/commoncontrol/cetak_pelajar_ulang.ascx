<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="cetak_pelajar_ulang.ascx.vb" Inherits="apkv_v2_admin.cetak_pelajar_ulang" %>

<table class="fbform">
    <tr class="fbform_header">
        <td colspan="3">Calon Ulang >> Jana Penyata Pendaftaran Ulang</td>
    </tr>
</table>
...
<table class="fbform">
    <tr class="fbform_header">
        <td colspan="3">Tetapan Tahun dan Sesi Peperiksaan</td>
    </tr>
    <tr style="text-align: center;">
        <td style="width: 10%;">Tahun :
            <asp:DropDownList ID="ddlTahun_Semasa" runat="server" AutoPostBack="false" Width="70px" Height="17px"></asp:DropDownList>
            &nbsp;
               Sesi :
