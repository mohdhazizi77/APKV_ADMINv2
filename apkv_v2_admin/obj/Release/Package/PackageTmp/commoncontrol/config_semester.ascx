<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="config_semester.ascx.vb" Inherits="apkv_v2_admin.config_semester1" %>
<table class="fbform">
    <tr class="fbform_header">
        <td colspan="2">Konfigurasi Umum >> Semester</td>
    </tr>
</table>
<br />
<table class="fbform">
    <tr class="fbform_header">
        <td colspan="2">Semester
        </td>
    </tr>
    <tr>
         <td >Semester:</td>
         <td><asp:TextBox ID="txtSemester" runat="server" Width="350px" MaxLength="50"></asp:TextBox></td>
    </tr>
    <tr>
    ...
    <tr>
         <td colspan="2">
            <asp:GridView ID="datRespondent" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                CellPadding="4" ForeColor="#333333" GridLines="None" DataKeyNames="SemesterID"
