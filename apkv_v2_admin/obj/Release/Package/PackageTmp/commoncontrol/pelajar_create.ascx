...
<table class="fbform">
    ...
    <tr>
        ...
        <td>
            <asp:Label ID="Label1" runat="server" Text="PRA DIPLOMA"></asp:Label></td>
    </tr>
    <tr>
        <td>Kohort:</td>
        <td>
    ...
    <tr>
        <td>Nama Bidang:</td>
        <td>
            <asp:DropDownList ID="ddlKluster" runat="server" AutoPostBack="true" Width="350px"></asp:DropDownList></td>
    </tr>
    <tr>
        <td>Kod Program:</td>
        <td>
