<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="svmu_senarai_calon_sj.ascx.vb" Inherits="apkv_v2_admin.svmu_senarai_calon_sj" %>

<table class="fbform">
    <tr class="fbform_header">
        <td colspan="2">Senarai Calon SVMU Sejarah</td>
    </tr>
</table>
<br />
<%--<table class="fbform">
...
<table class="fbform">
    <tr class="fbform_header">
        <td colspan="2">Paparan Maklumat Calon SVMU Sejarah </td>
    </tr>
    <tr>
        <td colspan="2">
...
<table class="fbform" style="width: 100%">
    ...
    <tr class="fbform_header">
        <td>Cetak Senarai Calon SVMU Sejarah</td>
    </tr>
