<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="wajaranakademik_view.ascx.vb" Inherits="apkv_v2_admin.wajaranakademik_view" %>
<table class="fbform">
    ...
    <tr>
           <td >Berterusan</td>
           <td style="text-align:center; width:1%;">:</td>
           <td><asp:Label ID="lblBerterusan" runat="server" Text=""></asp:Label></td>
    </tr>
    <tr>
         <td >Akhir</td>
         <td style="text-align:center; width:1%;">:</td>
         <td><asp:Label ID="lblAkhir" runat="server" Text=""></asp:Label></td>
    </tr>
    <tr>
           <td >Jenis</td>
           <td style="text-align:center; width:1%;">:</td>
