<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="pentaksirbm_borang_markah_induk.ascx.vb" Inherits="apkv_v2_admin.pentaksirbm_borang_markah_induk1" %>
...
<table class="fbform">
    ...
    <tr>
        <td>
            ...
            <asp:DropDownList ID="ddlJenisBorang" runat="server" Width="250px" AutoPostBack="true"></asp:DropDownList>
        </td>
    </tr>
    <tr>
        <td>
            <asp:Label ID="Label7" runat="server" Text="Pusat Peperiksaan :" Width="150px"></asp:Label>
            <asp:DropDownList ID="ddlPP" runat="server" Width="250px" AutoPostBack="true"></asp:DropDownList>
        </td>
    </tr>
    <tr>
        <td>
