<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="gred_bmsetara_create.ascx.vb" Inherits="apkv_v2_admin.gred_bmsetara_create" %>
<table class="fbform">
    <tr class="fbform_header">
        <td colspan="2">Konfigurasi >> Gred BM Setara >> Pendaftaran Baru</td>
    </tr>
</table>
<br />
<table class="fbform">
