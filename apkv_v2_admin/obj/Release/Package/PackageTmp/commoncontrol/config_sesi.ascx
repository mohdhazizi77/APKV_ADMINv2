<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="config_sesi.ascx.vb" Inherits="apkv_v2_admin.config_sesi1" %>
<table class="fbform">
    <tr class="fbform_header">
        <td colspan="2">Konfigurasi Umum >> Sesi</td>
    </tr>
</table>
<br />
<table class="fbform">
    ...
    <tr>
         <td>Sesi:</td>
         <td><asp:TextBox ID="txtSesi" runat="server" Width="350px" MaxLength="50"></asp:TextBox></td>
    </tr>
    <tr>
    ...
    <tr>
        <td colspan="2">
            <asp:GridView ID="datRespondent" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                CellPadding="4" ForeColor="#333333" GridLines="None" DataKeyNames="SesiID"
