<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="svmu_calon_manual_kemaskini.ascx.vb" Inherits="apkv_v2_admin.svmu_calon_manual_kemaskini" %>
...
<table style="width: 100%">
    ...
    <tr>
        ...
        <td style="text-align: right">
            <asp:Button ID="btnProceed" runat="server" Text="Tambah" />
        </td>
