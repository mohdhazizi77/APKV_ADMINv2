<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="markah_ulang_akademik_insert_v2.ascx.vb" Inherits="apkv_v2_admin.markah_ulang_akademik_insert_v21" %>
...
<table class="fbform">
    ...
    <tr>
        ...
        <td>
            <asp:CheckBoxList ID="chkSesi" runat="server" AutoPostBack="true" Width="349px" RepeatDirection="Horizontal">
                <asp:ListItem Enabled="True" Selected="True">1</asp:ListItem>
    ...
    <tr>
        ...
        <td>
            <asp:DropDownList ID="ddlMatapelajaran" runat="server" AutoPostBack="true" Width="350px"></asp:DropDownList></td>
    </tr>
    <tr>
        <td colspan="2">
...
<br />
<div class="info" id="divNote" runat="server">
    <p><span style="color: red">1. Pastikan markah PA yang dimasukkan adalah per 100.</span></p>
    <p><span style="color: red">2. Bagi markah Sains dan Pendidikan Islam, sila masukkan markah akhir iaitu gabungan markah kertas 1 dan kertas 2.</span></p>
    <p><span style="color: red">3. Selepas gred dijana, mohon jana semula slip keputusan pelajar tersebut.</span></p>
</div>
<table class="fbform">
    <tr class="fbform_header">
        <td>Senarai Calon
