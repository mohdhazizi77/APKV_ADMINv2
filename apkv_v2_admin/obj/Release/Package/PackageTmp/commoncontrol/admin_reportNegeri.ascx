<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="admin_reportNegeri.ascx.vb" Inherits="apkv_v2_admin.admin_reportNegeri" %>
<table class="fbform">
...
<table class="fbform">
    ...
    <tr>
        <td>
            Jumlah Keseluruhan Pelajar SEM1:<td><asp:Label ID="lblSem1" runat="server" Text="0"></asp:Label><td>
        </td>
    </tr>
      <tr>
        <td>
            Jumlah Keseluruhan Pelajar SEM2:<td><asp:Label ID="lblSem2" runat="server" Text="0"></asp:Label><td>
        </td>
    </tr>
      <tr>
        <td>
            Jumlah Keseluruhan Pelajar SEM3:<td><asp:Label ID="lblSem3" runat="server" Text="0"></asp:Label><td>
        </td>
          
    </tr>
      <tr>
        <td>
            Jumlah Keseluruhan Pelajar SEM4:<td><asp:Label ID="lblSem4" runat="server" Text="0"></asp:Label><td>
        </td>
    </tr>
      <tr>
        <td>
            Jumlah Keseluruhan Pelajar:<td><asp:Label ID="lblJumlah" runat="server" Text="0"></asp:Label><td>
        </td>
    </tr>
</table>