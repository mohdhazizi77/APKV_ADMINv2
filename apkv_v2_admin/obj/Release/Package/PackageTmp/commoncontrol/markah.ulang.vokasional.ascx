<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="markah.ulang.vokasional.ascx.vb" Inherits="apkv_v2_admin.markah_ulang_vokasional" %>
<table class="fbform">
    <tr class="fbform_header">
        <td colspan="2">Pendaftaran Calon Ulang >> Markah Ulang Vokasional</td>
    </tr>
</table>
<br />
<table class="fbform">
...
<table class="fbform">
 <tr>
     ...
     <tr>
           <td style="width: 20%;">Sesi Pengmbilan:</td>
    ...
    <tr>
        <td>
            <asp:GridView ID="datRespondent" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                CellPadding="4" ForeColor="#333333" GridLines="None" DataKeyNames="PelajarUlangVID"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Nama Kursus">
                        <ItemTemplate>
                            <asp:Label ID="NamaModul" runat="server" Width="30px"  Text='<%# Bind("NamaModul")%>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                     <asp:TemplateField HeaderText="PB Teori">
                        <ItemTemplate>
                            <asp:Textbox ID="MarkahPBTeori" runat="server" Width="30px" Text='<%# Bind("MarkahPBTeori")%>'></asp:Textbox>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="PB Amali">
                        <ItemTemplate>
                            <asp:Textbox ID="MarkahPBAmali" runat="server" Width="30px" Text='<%# Bind("MarkahPBAmali")%>'></asp:Textbox>
                        </ItemTemplate>
                    </asp:TemplateField>
                     <asp:TemplateField HeaderText="PA Teori">
                        <ItemTemplate>
                            <asp:Textbox ID="MarkahPATeori" runat="server" Width="30px" Text='<%# Bind("MarkahPATeori")%>'></asp:Textbox>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="PA Amali">
                        <ItemTemplate>
                            <asp:Textbox ID="MarkahPAAmali" runat="server" Width="30px" Text='<%# Bind("MarkahPAAmali")%>'></asp:Textbox>
                        </ItemTemplate>
                    </asp:TemplateField>
