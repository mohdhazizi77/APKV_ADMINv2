<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="borang_kawalan_transkrip.ascx.vb" Inherits="apkv_v2_admin.borang_kawalan_transkrip1" %>
...
<table class="fbform" style="width: 100%">
    ...
    <tr class="fbform_header">
        <td>Borang Kawalan Sijil Vokasional Malaysia (Transkrip)</td>
    </tr>
