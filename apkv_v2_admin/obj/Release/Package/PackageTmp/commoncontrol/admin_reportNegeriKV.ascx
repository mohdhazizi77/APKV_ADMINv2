<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="admin_reportNegeriKV.ascx.vb" Inherits="apkv_v2_admin.admin_reportNegeriKV" %>
<table class="fbform">
    ...
    <tr>      
        <td> <asp:Button ID="btnSearch" runat="server" Text="Cari " CssClass="fbbutton" /></td>
    </tr>
 </table> 
<br />
