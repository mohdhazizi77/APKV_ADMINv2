<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="kelas.view.ascx.vb" Inherits="apkv_v2_admin.kelas_view" %>
<table class="fbform">
...
<table class="fbform">
    ...
    <tr>
        <td >Kod Program:</td>
        <td><asp:Label ID="lblKodKursus" runat="server"></asp:Label><asp:Label ID="lblKursusID" runat="server" Visible ="false" ></asp:Label>
        </td>
    </tr>
    <tr>
          <td >Nama Program:</td>
