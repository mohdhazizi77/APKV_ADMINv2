<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="markah_PA_kertas.ascx.vb" Inherits="apkv_v2_admin.markah_PA_kertas" %>
<table class="fbform">
    <tr class="fbform_header">
        <td colspan="2">Vokasional>>Pemeriksa>>Markah PA</td>
    </tr>
</table>
<br />
            ...
            <asp:GridView ID="datRespondent" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Markah">
                        <ItemTemplate>
                            <asp:TextBox ID="A_Teori1" runat="server" Width="30px"  Text='<%# Bind("A_Teori1")%>'></asp:TextBox>
                        </ItemTemplate>
                    </asp:TemplateField>
                     <asp:TemplateField HeaderText="Catatan">
                        <ItemTemplate>
                            <asp:TextBox ID="CatatanPA" runat="server" Width="30px"  Text='<%# Bind("CatatanPA")%>'></asp:TextBox>
                        </ItemTemplate>
                    </asp:TemplateField>
