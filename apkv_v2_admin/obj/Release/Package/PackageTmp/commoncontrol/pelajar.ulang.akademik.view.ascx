<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="pelajar.ulang.akademik.view.ascx.vb" Inherits="apkv_v2_admin.peajar_ulang_akademik_view" %>
<table class="fbform">
    <tr class="fbform_header">
        <td colspan="2">Carian Dan Penyelengaraan >> Calon >> Paparan Calon Ulang Akademik </td>
    </tr>
</table>
<br />
<table class="fbform">
