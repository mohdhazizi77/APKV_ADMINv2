<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="pentaksirbm_calon_bm4_serah.ascx.vb" Inherits="apkv_v2_admin.pentaksirbm_calon_bm4_serah1" %>

<table class="fbform">
    <tr class="fbform_header">
        <td colspan="2">Senarai Calon untuk Penghantaran Markah Ujian Mendengar Bahasa Melayu</td>
    </tr>
</table>
