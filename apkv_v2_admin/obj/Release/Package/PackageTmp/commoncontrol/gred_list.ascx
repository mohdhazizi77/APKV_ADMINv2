<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="gred_list.ascx.vb" Inherits="apkv_v2_admin.gred_list" %>
<table class="fbform">
...
<table class="fbform">
    ...
    <tr>
        <td colspan="2">
            <asp:Button ID="btnSearch" runat="server" Text="Cari " CssClass="fbbutton" />&nbsp; <asp:Button ID="btnDaftar" runat="server" Text="Daftar Baru " CssClass="fbbutton" />
        </td>
    </tr>
</table>
<br />
