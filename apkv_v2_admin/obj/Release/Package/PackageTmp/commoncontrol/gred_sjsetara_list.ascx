<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="gred_sjsetara_list.ascx.vb" Inherits="apkv_v2_admin.gred_sjsetara_list1" %>

<table class="fbform">
    <tr class="fbform_header">
        <td colspan="2">Konfigurasi >> Gred SJ Setara </td>
    </tr>
</table>
<br />
<table class="fbform">
...
<table class="fbform">
    <tr class="fbform_header">
         <td colspan="2">Senarai Gred SJ Setara</td>
    </tr>
    <tr>
         <td colspan="2">
