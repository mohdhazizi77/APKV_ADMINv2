<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="pentaksirbm_default.ascx.vb" Inherits="apkv_v2_admin.pentaksirbm_default" %>

<br />
<table class="fbform">
    <tr class="fbform_header">
        <td colspan="2">Login Pentaksir Bahasa Melayu Setara
        </td>
    </tr>
    <tr>
        <td style="width: 80px;">
