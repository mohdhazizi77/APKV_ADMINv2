<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="borang_markah_sejarah.ascx.vb" Inherits="apkv_v2_admin.borang_markah_sejarah1" %>
<table class="fbform">
    <tr class="fbform_header">
        <td colspan="2">Pemeriksa >> Borang Markah >> Jana Borang Markah Sejarah</td>
    </tr>
</table>
<br />
<table class="fbform">
    ...
    <tr>
     ...
     <tr>
        <td >Kod Pusat:</td>
        <td><asp:DropDownList ID="ddlKodPusat" runat="server" AutoPostBack="true" Width="250px"></asp:DropDownList>
        </td>
    </tr>
    <tr>
        <td>Nama Kolej:</td>
...
<table class="fbform">
    <tr class="fbform_header">
        <td colspan="2">Borang Pengisian Markah Bertulis- Sejarah</td>
    </tr>
    <tr>
           <td >Tahun Semasa:</td>
            ...
            <asp:GridView ID="datRespondent" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Sejarah">
                         <ItemTemplate>
                            <asp:TextBox ID="txtSJ" runat="server" Width="30px" MaxLength="3" ></asp:TextBox>
                        </ItemTemplate>
                          <HeaderStyle HorizontalAlign="Left" VerticalAlign="Middle" />
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Catatan">
                          <ItemTemplate>
                            <asp:TextBox ID="txtCatatanPS" runat="server" Width="30px" MaxLength="3" ></asp:TextBox>
                        </ItemTemplate>
                          <HeaderStyle HorizontalAlign="Left" VerticalAlign="Middle" />
                    </asp:TemplateField>
                </Columns>
