<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="wajaran_search.ascx.vb" Inherits="apkv_v2_admin.wajaran_search" %>
<table class="fbform">
                ...
                <Columns>
                   ...
                   <asp:TemplateField HeaderText="Berterusan">
                    ...
                    <asp:TemplateField HeaderText="Akhir">
                        <ItemTemplate>
                            <asp:Label ID="Akhir" runat="server" Text='<%# Bind("Akhir")%>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
