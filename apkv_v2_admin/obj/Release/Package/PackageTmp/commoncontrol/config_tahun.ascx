<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="config_tahun.ascx.vb" Inherits="apkv_v2_admin.config_tahun1" %>
<table class="fbform">
...
<table class="fbform">
    ...
    <tr>
         <td>Tahun:</td>
         <td><asp:TextBox ID="txtTahun" runat="server" Width="350px" MaxLength="350"></asp:TextBox></td>
    </tr>
    <tr>
        <td>Kod:</td>
