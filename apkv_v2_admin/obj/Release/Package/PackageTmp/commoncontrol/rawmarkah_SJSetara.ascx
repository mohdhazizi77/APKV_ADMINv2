<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="rawmarkah_SJSetara.ascx.vb" Inherits="apkv_v2_admin.rawmarkah_SJSetara" %>

<table class="fbform">
    <tr class="fbform_header">
        <td colspan="2">Jana >> raw markah SJ Setara</td>
    </tr>
</table>
        ...
        <td>
            <asp:GridView ID="datRespondent" runat="server" AutoGenerateColumns="False" AllowPaging="false" Visible="false"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="GRED_SJ1251">
                        <ItemTemplate>
                            <asp:Label ID="GRED_SJ1251" runat="server"></asp:Label>
                        </ItemTemplate>
                        <HeaderStyle HorizontalAlign="Left" />
                        <ItemStyle HorizontalAlign="Left" />
                    </asp:TemplateField>
